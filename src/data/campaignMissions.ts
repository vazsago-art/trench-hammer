...
const COMMON_LOCATIONS: ExplorationLocation[] = [
  ...
  },
  {
    ...
    factionChoices: [
      ...
      { name: 'Convert', description: 'You earn 1 additional Influence Point.', condition: ['t_au_empire'], conditionLabel: '(T\'au Empire Only)' },
  ...
  },
  {
    ...
    factionChoices: [
      ...
      { name: 'T\'au Empire', description: 'A Fire Warrior with the Pathfinder upgrade and a Pulse Blaster.', condition: ['t_au_empire'], conditionLabel: '(T\'au Empire Only)' },
...
const RARE_LOCATIONS: ExplorationLocation[] = [
  ...
  },
  {
    ...
    factionChoices: [
      ...
      { name: 'Convert', description: 'The next time you choose a Demographic, you earn 2 Infiltration Points immediately.', condition: ['t_au_empire'], conditionLabel: '(T\'au Empire Only)' },
...
const LEGENDARY_LOCATIONS: ExplorationLocation[] = [
  ...
  },
  {
    ...
    factionChoices: [
      ...
      { name: 'Convert', description: 'Choose a Demographic you have not Converted. Convert that Demographic.', condition: ['t_au_empire'], conditionLabel: '(T\'au Empire Only)' },
  ...
  },
  {
    ...
    factionChoices: [
      ...
      { name: 'T\'au Empire', description: 'A Kroot Carnivore with a Kroot Scattergun, Hunting Javelins, a Bladestave, a Kroothawk Flock, and a Medical Kit. You also gain a Missile Drone, which cannot become Elite or replace its NO PROMOTION keyword.', condition: ['t_au_empire'], conditionLabel: '(T\'au Empire Only)' },
