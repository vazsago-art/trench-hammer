...
export const thousandSonsEquipment: WargearOption[] = [
  ...
  { id: 'vox_unit_ts', name: 'Vox Unit', type: 'equipment', slot: 'equipment', cost: 15, limit: 1, keywords: ['HELD'], description: 'HELD. While bearer is not Down, friendly models within 4" add +1 DICE to their Dash Success Rolls. LIMIT: 1.' },
...
export const leaguesOfVotannEquipment: WargearOption[] = [
  ...
  { id: 'combat_helmet_votann', name: 'Combat Helmet', type: 'equipment', slot: 'headgear', cost: 5, keywords: ['NEGATE SHRAPNEL'], description: 'NEGATE SHRAPNEL.', grantsKeywords: ['NEGATE SHRAPNEL'] },
  { id: 'exoarmour_grenade_launcher', name: 'Exoarmour Grenade Launcher', type: 'equipment', slot: 'equipment', cost: 5, keywords: [], description: 'The range of Frag Grenades and Krak Grenades the equipped model attacks with is increased by 4”' },
  ...
  { id: 'rollbar_searchlight', name: 'Rollbar Searchlight', type: 'equipment', slot: 'equipment', cost: 10, keywords: ['IGNORE LONG RANGE'], description: 'Ignore Long Range penalties. Pioneer Only.' },
  ...
  { id: 'kahyrm_war_plate_votann', name: 'Kâhyrm’s War Plate', type: 'armor', slot: 'body-armour', cost: 9, costCurrency: 'glory', limit: 1, keywords: [], description: 'Counts as Power Armour, providing -2 INJURY MODIFIER. The equipped model gains the TOUGH Keyword.' },
  { id: 'thyrikite_plate_votann', name: 'Thyrikite Plate', type: 'armor', slot: 'body-armour', cost: 4, costCurrency: 'glory', limit: 1, keywords: [], description: '-3 INJURY MODIFIER' },
  { id: 'recyc_converter_votann', name: 'Recyc Converter', type: 'equipment', slot: 'equipment', cost: 2, costCurrency: 'glory', limit: 1, keywords: [], description: 'When the equipped model takes an enemy Out of Action with a Volkanite Disintegrator, Forgestar, Ion Blaster, or Grav Gun, gain Resources based on the enemy type: |TOUGH and not VEHICLE: 20 Biomatter |VEHICLE: 20 Raw Material |Neither of the above: 10 Biomatter |Worth any Glory: 20 Energy Sources (in addition to above)' },
  { id: 'warpestryk_votann', name: "Wârpestryk", type: 'equipment', slot: 'equipment', cost: 3, costCurrency: 'glory', limit: 1, keywords: [], description: 'Once during each of its Activations, when the equipped model moves, it can teleport, ignoring all terrain and models in between. Still must Retreat to leave melee and Charge to enter melee. 3 Glory. LIMIT: 1. Deep Strike Only.'},
  { id: 'wayfarer_grace_votann', name: "Wayfarer's Grace", type: 'equipment', slot: 'equipment', cost: 3, costCurrency: 'glory', limit: 1, keywords: ['REGENERATE 1'], description: 'REGENERATE 1. 3 Glory. Elite Only.', restrictedTo: ['ELITE'] },
];
