...
const SPECIAL_RANGED_IDS: string[] = [
  ...
  'melta_gun', 'plasma_gun', 'storm_bolter',
...
const HA_VARIANT_IDS: string[] = [
  ...
  'terrorchem_vials_nl',
  // Thousand Sons
  'disc_of_tzeentch_ts', 'icon_of_flame_ts', 'sigil_of_flame_ts', 'divining_spear_ts',
  'inferno_boltgun_ts', 'inferno_bolt_pistol_ts', 'inferno_combi_bolter_ts', 'hellfyre_missile_rack_ts',
  'force_stave_ts', 'power_claw_ts', 'soulreaper_cannon_ts', 'brayhorn_ts', 'herd_banner_ts',
  'meltagun_ts', 'hand_flamer_ts', 'fatecater_greatbow_ts', 'vox_unit_ts',
  // World Eaters
...
const HA_EXCLUDED_IDS: ReadonlySet<string> = new Set([
  ...
  'grenade_launcher', 'longlas', 'hand_flamer',
...
const FACTION_EXCLUDED_IDS: Partial<Record<string, ReadonlySet<string>>> = {
  adeptus_astartes: new Set([
    ...
    // Special Ranged (only flamer, longlas, melta_gun, plasma_gun, storm_bolter kept)
  ...
  adepta_sororitas: new Set([
    ...
    'grenade_launcher', 'plasma_gun', 'heavy_stubber', 'longlas',
  ...
  adeptus_mechanicus: new Set([
    ...
    'grenade_launcher', 'melta_gun', 'plasma_gun', 'storm_bolter', 'longlas',
  ...
  adeptus_custodes: new Set([
    ...
    'grenade_launcher', 'melta_gun', 'plasma_gun', 'heavy_stubber', 'longlas',
  ...
  adeptus_ministorum: new Set([
    ...
    'plasma_pistol',
    // Special Ranged (only flamer, grenade_launcher, heavy_stubber, longlas, melta_gun kept)
  ...
  leagues_of_votann: new Set([
    ...
    'electro_grenades', 'gunk_bombs', 'incendiary_grenades', 'melta_bombs', 'throwing_knives', 'toxin_grenades',
    // Basic Melee (only blade, bludgeon, ccw, halberd kept)
    'flail', 'paired_blades',
  ...
  thousand_sons: new Set([
    // Equipment
    'cyclone_missile_launcher', 'lightning_claw', 'icon_of_despair', 'icon_of_excess', 'icon_of_wrath', 'mark_of_nurgle', 'mark_of_khorne', 'mark_of_slaanesh', 
  ]) 
};
...
const HA_SUBFACTION_WARGEAR: Record<string, string[]> = {
  ...
  thousand_sons:    [
    ...
    'autogun', 'automatic_shotgun', 'bolt_carbine', 'boltgun', 'shotgun', 'las_carbine', 'las_rifle',
    // Pistols
    'autopistol', 'bolt_pistol', 'heavy_bolt_pistol', 'inferno_bolt_pistol_ts', 'plasma_pistol', 'twin_bolt_pistol', 'laspistol',
    ...
    'chain_blade', 'daemon_weapon', 'divining_spear_ts', 'fell_dagger', 'force_rod', 'force_staff', 'force_stave_ts', 'force_weapon', 'power_weapon',
    // Heavy Melee Weapons
    ...
    'herd_banner_ts', 'scope', 'shovel', 'sigil_of_flame_ts', 'vengeance_ammunition', 'vox_unit_ts',
...
const t_au_empire_SPECIFIC_IDS: string[] = [
...
const t_au_empire_WEAPON_IDS: string[] = [
  // Ranged
...
const LEAGUES_OF_VOTANN_SPECIFIC_IDS: string[] = [
  ...
  'rollbar_searchlight', 'scope_votann', 'vox_unit_votann', 'jump_pack',
  // Campaign Shop
...
const LEAGUES_OF_VOTANN_WEAPON_IDS: string[] = [
  // Standard Ranged
  'autogun', 'automatic_shotgun', 'boltgun', 'las_carbine', 'shotgun',
  // Special Ranged
  'etacarn_plasma_beamer', 'etacarn_plasma_gun', 'ion_blaster', 'iron_ambassador',
  'volkanite_disintegrator', 'grav_gun', 'grenadier_gauntlet', 'heavy_stubber',
  // Pistols
  'etacarn_plasma_pistol', 'ion_pistol', 'grav_pistol', 'heavy_bolt_pistol',
  // Heavy ranged
  'heavy_volkanite_disintegrator', 'ion_beamer', 'magna_rail_rifle', 'sp_conversion_beamer', 'combi_bolter', 'grav_cannon', 'missile_launcher',
  // Thrown
  'throwing_plasma_knives', 'blasting_charge',
  // Melee
  'force_rod', 'force_staff',
...
export const FACTION_WARGEAR: Record<string, string[]> = {
  ...
  t_au_empire:           ['blade', 'bludgeon', ...t_au_empire_SPECIFIC_IDS, ...t_au_empire_WEAPON_IDS],
...
export const UNIT_WARGEAR_OVERRIDES: Record<string, string[]> = {
  ...
  oa_aspirant: [
    ...
    'frag_grenades', 'smoke_grenades', 'krak_grenades',
  ],
  oa_eversor: [
    'autopistol',
    ...BASIC_MELEE_IDS,
  ...
  ts_tzaangor: [
    ...
    ...EQUIPMENT_IDS,
    'chaos_sigil', 'combat_helmet_ha', 'astartes_bike', 'brayhorn_ts', 'filter_plugs', 'grapnel_launcher', 'grav_chute', 'herd_banner_ts',
    'vox_unit_ts', 'icon_of_flame', 
    'astartes_bike', 'vengeance_ammunition',
  ],
  ...
  ts_tzaangor_shaman: [
    ...
    ...EQUIPMENT_IDS,
    'chaos_sigil', 'combat_helmet_ha', 'icon_of_vengeance_ha',
    'icon_of_flame',
    'astartes_bike', 'vengeance_ammunition',
...
const FACTION_WARGEAR_NOTES: Record<string, Record<string, string>> = {
  ...
  thousand_sons: {
    ...
    // Special Ranged Weapons
    fatecater_greatbow_ts:      'LIMIT: 1, Tzaangor Only',
    flamer:                  'LIMIT: 3',
    ...
    grav_chute:              'LIMIT: 2',
    icon_of_flame_ts:        'LIMIT: 1 total Icon, Mark of Tzeentch Only',
  ...
  leagues_of_votann: {
    ...
    autogun:                 'LIMIT: 2',
    // Pistols
    etacam_plasma_pistol:    'LIMIT: 2',
    grav_pistol:             'LIMIT: 2',
    heavy_bolt_pistol:       'LIMIT: 1',
    ion_pistol:              'Elite Only, LIMIT: 2',
    // Special Ranged Weapons
    grav_gun:                'LIMIT: 1',
    grenadier_gauntlet:      'Hearthguard Only',
    grenade_launcher:        'LIMIT: 1',
    heavy_stubber:           'LIMIT: 2',
    iron_ambassador:         'LIMIT: 1',
    volkanite_disintegrator: 'LIMIT: 2',
    // Heavy Ranged Weapons
    autocannon:              'LIMIT: 1',
    combi_bolter:            'LIMIT: 1',
    grav_cannon:             'LIMIT: 2',
    heavy_bolter:            'LIMIT: 2',
    heavy_volkanite_disintegrator: 'LIMIT: 1',
    ion_beamer:              'LIMIT: 1',
    magna_rail_rifle:        'LIMIT: 1',
    missile_launcher:         'LIMIT: 1',
    mole_launcher:           'LIMIT: 1',
    // Thrown Weapons
    blasting_charge:         'LIMIT: 2',
    krak_grenade:            'LIMIT: 2',
    smoke_grenades:           'LIMIT: 1',
    // Special Melee Weapons
    concussion_gauntlet:     'LIMIT: 2',
    force_rod:               'Psyker Only',
    force_staff:             'Psyker Only',
    plasma_blade:            'LIMIT: 4',
    twin_concussion_gauntlets: 'LIMIT: 1',
    // Heavy Melee Weapons
    heavy_concussion_gauntlet:'Steeljack Only',
    heavy_plasma_blade:      'LIMIT: 2',
    thunder_hammer:          'LIMIT: 2, Elite Only',
    twin_heavy_concussion_gauntlets:'Steeljack Only',
    // Armour
    shield:                  'Elite or Hearthguard Only',
    // Equipment
    ancestral_crest:         'LIMIT: 1, Elite Only, Headgear',
    combat_helmet_votann:    'Headgear',
    exoarmour_grenade_launcher:'Hearthguard Only',
    grapnel_launcher:        'LIMIT: 2',
    grey_crest:              'LIMIT: 1, Elite Only, Headgear',
    jump_pack:               'LIMIT: 1, Hearthkyn Only',
    mass_driver_accelerators:'Hearthguard Only',
    multispectral_visor_votann: 'LIMIT: 2',
    preymark_crest:          'LIMIT: 1, Elite or Steeljack Only, Headgear',
    scope_votann:            'LIMIT: 1',
    rampart_crest:           'LIMIT: 1, Elite Only, Headgear',
    rollbar_searchlight:     'Pioneer Only',
    teleport_crest:          'LIMIT: 3, Elite or Hearthguard Only, Headgear',
    weavefield_crest:        'LIMIT: 1, Elite or Hearthguard Only, Headgear',
    vox_unit_votann:         'LIMIT: 1',
    // Campaign Only
    captive_abyss_votann:           'LIMIT: 1',
    exactor_votann:                 'LIMIT: 1, Elite Only',
    forgestar_votann:               'LIMIT: 1, Elite Only',
    grudge_end_votann:              'LIMIT: 1',
    kahyrm_war_plate_votann:        'LIMIT: 1, Elite Only',
    murmuring_stave_votann:         'LIMIT: 1',
    recyc_converter_votann:         'LIMIT: 1',
    thyrikite_plate_votann:         'LIMIT: 1',
    warpestryk_votann :             'LIMIT: 1, Deep Strike Only',
    wayfarer_grace_votann:          'Elite Only',
  },
