...
export const ha_lord_kakophonist: UnitOption = {
  ...
  defaultWargear: [
    ...
    { id: 'ha_mark_slaanesh_kak', name: 'Mark of Slaanesh', type: 'equipment', slot: 'equipment', cost: 0,
      keywords: ['SLAANESH'],
      description: 'Included in cost. +2" movement speed, +1 DICE to all Dash Success Rolls.',
...
export const ha_exalted_sorcerer: UnitOption = {
  ...
  defaultWargear: [
    ...
    { id: 'ha_mark_tzeentch_es', name: 'Mark of Tzeentch', type: 'equipment', slot: 'equipment', cost: 0,
      keywords: ['TZEENTCH'],
      description: 'Included in cost. Ranged attacks have +1 INJURY MODIFIER.' },
  ], availableWargear: [],
};
...
export const ha_master_of_executions: UnitOption = {
  ...
  defaultWargear: [
    ...
    { id: 'ha_mark_khorne_moe', name: 'Mark of Khorne', type: 'equipment', slot: 'equipment', cost: 0,
      keywords: ['KHORNE'],
      description: 'Included in cost. Melee attacks have +1 INJURY MODIFIER.' },
  ], availableWargear: [],
};
...
export const or_big_mek: UnitOption = {
  ...
  faction: 'orks', unitType: 'elite',
  description: 'Ork mekanic and inventor.',
  defaultWargear: [], availableWargear: [],
};
export const or_weirdboy: UnitOption = {
  ...
  faction: 'orks', unitType: 'elite',
  description: 'Warp-touched Ork psyker. (35cr + 5cr staff)',
  defaultWargear: [
...
export const or_deff_dread: UnitOption = {
  ...
  faction: 'orks', unitType: 'troop',
  description: 'Ramshackle Ork walker.',
  defaultWargear: [
...
export const ael_aspect_warrior: UnitOption = {
  id: 'ael_aspect_warrior', name: 'Aspect Warrior', baseCost: 65, minCount: 0, maxCount: 6,
  stats: { movement: 7, rangedSkill: 2, meleeSkill: 2, armourSave: 0, toughness: 'NORMAL' },
  keywords: ['AELDARI'],
  faction: 'aeldari', unitType: 'troop',
  description: 'Dedicated Path warrior. 8 aspect types; LIMIT 2 per type.',
  defaultWargear: [], availableWargear: [],
};
...
export const tau_ethereal: UnitOption = {
  ...
  description: 'Mandatory Ethereal caste leader.',
  defaultWargear: [], availableWargear: [],
};
export const tau_commander: UnitOption = {
  ...
  faction: 't_au_empire', unitType: 'elite',
  description: 'T\'au Commander battlesuit.',
  defaultWargear: [], availableWargear: [],
};
export const tau_cadre_fireblade: UnitOption = {
  ...
  faction: 't_au_empire', unitType: 'elite',
  description: 'Elite Fire Warrior leader.',
  defaultWargear: [], availableWargear: [],
};
...
export const tau_fire_warrior: UnitOption = {
  ...
  description: 'Standard T\'au ranged infantry.',
  defaultWargear: [], availableWargear: [],
  upgrades: [
...
export const tau_drone: UnitOption = {
  ...
  faction: 't_au_empire', unitType: 'troop',
  description: 'Support drone. (+ type cost). Max = non-KROOT models.',
  defaultWargear: [], availableWargear: [],
  unitSubTypes: [
...
export const tau_stealth_battlesuit: UnitOption = {
  ...
  faction: 't_au_empire', unitType: 'troop',
  description: 'Stealthy XV25 battlesuit.',
  defaultWargear: [], availableWargear: [],
};
export const tau_crisis_battlesuit: UnitOption = {
  ...
  faction: 't_au_empire', unitType: 'troop',
  description: 'XV8 Crisis battlesuit.',
  defaultWargear: [], availableWargear: [],
};
export const tau_broadside_battlesuit: UnitOption = {
  ...
  faction: 't_au_empire', unitType: 'troop',
  description: 'Retaliation Cadre variant: heavy support battlesuit.',
  defaultWargear: [], availableWargear: [],
};
export const tau_kill_broker: UnitOption = {
  ...
  faction: 't_au_empire', unitType: 'elite',
  description: 'Kroot Kinband variant: mercenary leader.',
  defaultWargear: [], availableWargear: [],
};
export const tau_krootox_rider: UnitOption = {
  ...
  faction: 't_au_empire', unitType: 'troop',
  description: 'Kroot Kinband variant: Kroot mounted on Krootox. (0-3 at 1200cr+)',
  defaultWargear: [], availableWargear: [],
  upgrades: [
...
export const faction_orks: Faction = {
  ...
  units: applyAbilities([or_warboss, or_big_mek, or_weirdboy, or_gretchin, or_boy, or_nob, or_squig, or_deff_dread]),
};
...
export const faction_drukhari: Faction = {
  ...
  units: applyAbilities([dr_archon, dr_haemonculus, dr_succubus, dr_kabalite_warrior, dr_incubus, dr_wrack, dr_wych, dr_reaver, dr_cronos, dr_talos]),
};
...
export const faction_genestealer_cults: Faction = {
  ...
  units: applyAbilities([gc_primus, gc_clamavus, gc_magus, gc_nexos, gc_neophyte, gc_acolyte, gc_aberrant, gc_abominant]),
};
