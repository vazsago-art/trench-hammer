...
const LOV_BASE_WARGEAR_LIMITS: Record<string, number> = {
  ...
  heavy_stubber: 2,
  iron_ambassador: 1,
  volkanite_disintegrator: 2,
  // Heavy ranged weapons
  autocannon: 1,
  combi_bolter: 1,
  grav_cannon: 2,
  heavy_bolter: 2,
  heavy_volkanite_disintegrator: 1,
  ion_beamer: 1,
  magna_rail_rifle: 1,
  missile_launcher: 1,
  mole_launcher: 1,
  ...
  concussion_gauntlet: 2,
  plasma_blade: 4,
  twin_concussion_gauntlets: 1,
  // Heavy melee weapons
  heavy_plasma_blade: 2,
  thunder_hammer: 2,
  // Equipment
  ancestral_crest: 1,
  grapnel_launcher: 2,
...
const ADEPTUS_ASTARTES_SUBFACTIONS: SubFaction[] = [
  ...
  },
  {
    ...
    wargearCostOverrides: {
      ...
      incendiary_grenades: { cost: 10, costCurrency: 'credits' },
    },
    wargearLimitOverrides: {
