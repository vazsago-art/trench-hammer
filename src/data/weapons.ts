...
export const sharedSpecialRangedWeapons: Weapon[] = [
  ...
  },
  {
    ...
    range: 12,
    cost: 30,
    keywords: ['BLAST 2"', 'SHRAPNEL', 'IGNORE COVER'],
    description: '12" BLAST 2", SHRAPNEL, IGNORE COVER. Takes no hands.'
  },
  {
    id: 'grenade_launcher',
    ...
    limit: 1,
    handedness: 'two-handed',
    keywords: ['BLAST 2"', 'SHRAPNEL', 'IGNORE COVER', 'TWO-HANDED'],
    description: '24" BLAST 2", SHRAPNEL, IGNORE COVER, TWO-HANDED.'
  },
  {
    id: 'heavy_stubber',
    name: 'Heavy Stubber',
  ...
  },
  {
    ...
    limit: 1,
    handedness: 'two-handed',
    keywords: ['+1 INJURY DICE vs DAEMON/PSYKER', 'IGNORE ARMOUR on Critical Hit', 'CRITICAL', 'TWO-HANDED'],
...
export const sharedHeavyRangedWeapons: Weapon[] = [
  ...
  },
  {
    ...
    cost: 25,
    handedness: 'no-hands',
    keywords: ['BLAST 2"', 'SHRAPNEL', 'IGNORE COVER', 'HEAVY'],
    description: '36" BLAST 2", SHRAPNEL, IGNORE COVER, HEAVY, takes no hands.'
  },
  {
    id: 'grav_cannon',
    name: 'Grav Cannon',
  ...
  },
  {
    ...
    limit: 1,
    handedness: 'two-handed',
    keywords: ['BLAST 2"', 'SHRAPNEL', 'IGNORE COVER', 'HEAVY', 'TWO-HANDED'],
    description: '36" BLAST 2", SHRAPNEL, IGNORE COVER, HEAVY, TWO-HANDED.'
  },
  {
    id: 'mole_launcher',
    name: 'Mole Launcher',
  ...
  },
  {
    ...
    limit: 1,
    handedness: 'two-handed',
    keywords: ['AUTOMATIC 2', '+1 DICE', 'HEAVY', 'TWO-HANDED'],
    description: '36" AUTOMATIC 2, +1 DICE, HEAVY, TWO-HANDED.'
  },
  {
    id: 'twin_lascannon',
    name: 'Twin Lascannon',
  ...
  },
  {
    ...
    description: '18" +1 INJURY DICE, HEAVY, RISKY, TWO-HANDED. On hit: target (including Down models) moves D6" directly towards wielder (non-LARGE only for drag effect).'
  },
  {
...
export const sharedThrownWeapons: Weapon[] = [
  ...
  },
  {
    ...
    cost: 15,
    limit: 1,
    keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', 'ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'STUN', 'THROWN'],
    description: '8" IGNORE ARMOUR, -1 INJURY DICE, ASSAULT, BLAST 3", FUMBLE, STUN, THROWN.'
  },
  {
    id: 'frag_grenades',
    name: 'Frag Grenades',
    ...
    range: 8,
    cost: 15,
    keywords: ['ASSAULT', 'BLAST 2"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'SHRAPNEL', 'THROWN'],
    description: '8" ASSAULT, BLAST 2", FUMBLE, SHRAPNEL, THROWN.'
  },
  {
    id: 'gunk_bombs',
    name: 'Gunk Bombs',
    ...
    cost: 7,
    limit: 1,
    keywords: ['ASSAULT', 'BLAST 2"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'STUN MARKERS', 'STUN', 'THROWN'],
    description: '8" ASSAULT, BLAST 2", FUMBLE, STUN MARKERS, STUN, IGNORE COVER, IGNORE LONG RANGE, THROWN.'
  },
  {
    ...
    cost: 10,
    limit: 1,
    keywords: ['IGNORE ARMOUR on Critical Hit', 'ASSAULT', 'FIRE', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'],
    description: '8" IGNORE ARMOUR on Critical Hit, ASSAULT, FIRE, FUMBLE, THROWN.'
  },
  {
    id: 'krak_grenades',
    name: 'Krak Grenades',
    ...
    cost: 15,
    limit: 2,
    keywords: ['ASSAULT', 'ARMOUR PIERCING 2', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'],
    description: '8" ASSAULT, ARMOUR PIERCING 2, FUMBLE, THROWN.'
  },
  {
    id: 'melta_bombs',
    name: 'Melta Bombs',
    ...
    cost: 20,
    limit: 1,
    keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'ASSAULT', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'RISKY', 'THROWN'],
    description: '6", +1 INJURY DICE, IGNORE ARMOUR, ASSAULT, FUMBLE, RISKY, THROWN.'
  },
  {
    id: 'throwing_knives',
  ...
  },
  {
    ...
    cost: 20,
    limit: 1,
    keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', 'ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'GAS', 'THROWN'],
    description: '8" IGNORE ARMOUR, -1 INJURY DICE, ASSAULT, BLAST 3", FUMBLE, GAS, THROWN.'
  },
  {
    ...
    range: 8,
    cost: 20,
    keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', 'ASSAULT', 'BLAST 2"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'STUN', 'THROWN'],
    description: '8" IGNORE ARMOUR, -1 INJURY DICE, ASSAULT, BLAST 2", FUMBLE, STUN, THROWN.'
  },
  {
    id: 'smoke_grenades',
    name: 'Smoke Grenades',
...
export const sharedSpecialMeleeWeapons: Weapon[] = [
  ...
  },
  {
    ...
    cost: 15,
    isMainHandOnly: true,
    keywords: ['IGNORE ARMOUR on Critical Hit', 'CRITICAL', 'SHRAPNEL', 'RISKY', 'MAIN HAND ONLY'],
  ...
  },
  {
    ...
    cost: 23,
    handedness: 'two-handed',
    keywords: ['+1 DICE', '+1 INJURY DICE', 'IGNORE ARMOUR on Critical Hit', 'CRITICAL', 'SHRAPNEL', 'RISKY', 'TWO-HANDED', 'CUMBERSOME'],
  ...
  // ── Adepta Sororitas unique melee weapons ──────────────────────────────────
  {
    ...
    limit: 2,
    isMainHandOnly: true,
    keywords: ['IGNORE ARMOUR on Critical Hit', 'CRITICAL', 'STUN', 'WHIP 3"', 'MAIN HAND ONLY'],
  ...
  },
  {
    ...
    description: 'HELD, FIRE. Strike: Melee, MAIN HAND ONLY. Unleash: 8" FLAMETHROWER, -1 INJURY DICE, IGNORE ARMOUR (once per battle). (Sororitas only, LIMIT: 1)',
  },
  // ── Paragon Warsuit Weapons ──────────────────────────────────────────────
  {
    ...
    limit: 1,
    handedness: 'two-handed',
    keywords: ['AUTOMATIC 2', 'ASSAULT', 'TWO-HANDED'],
    description: '24", AUTOMATIC 2, ASSAULT, TWO-HANDED. LIMIT: 1. Paragon Warsuit Only. (Sororitas only)',
  },
  {
  ...
  // ── Alpha Legion: Blasting Charge (LIMIT: 2) and Melta Bombs (15 credits) ────
  {
    id: 'blasting_charge_al',
    name: 'Blasting Charge',
    type: 'thrown',
    range: 6,
    cost: 15,
    limit: 2,
    keywords: ['+1 INJURY DICE', 'BLAST 3"', 'CONSUMABLE', 'HEAVY', 'SCATTER', 'THROWN'],
    description: '6" +1 INJURY DICE, BLAST 3", CONSUMABLE, HEAVY, SCATTER, THROWN. LIMIT: 2. (Alpha Legion Only)'
  },
  {
    id: 'melta_bombs_al',
    name: 'Melta Bombs',
    ...
    limit: 1,
    keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'ASSAULT', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'RISKY', 'THROWN'],
    description: '6", +1 INJURY DICE, IGNORE ARMOUR, ASSAULT, FUMBLE, RISKY, THROWN. LIMIT: 1. (Alpha Legion Only)'
  },
  // ── Heretic Astartes Variant Battlekit: Death Guard ───────────────────────
  {
    ...
    cost: 15,
    limit: 3,
    keywords: ['ASSAULT', 'BLAST 2"', 'IGNORE COVER', 'IGNORE LONG RANGE', 'INFECTION MARKERS'],
    description: '8", ASSAULT, BLAST 2", IGNORE COVER, IGNORE LONG RANGE, INFECTION MARKERS. LIMIT: 3. (Death Guard Only)'
  },
  {
  ...
  // ── Foetid Blight-Drone integrated weapons ───────────────────────────────
  {
    ...
    description: 'Melee, HEAVY, SHRAPNEL, TWO-HANDED. Hits Automatically; hits each enemy the wielder is in melee with during its Activation. (+0cr) Foetid Blight-Drone Only.',
    conflictsWith: ['twin_plague_spewers_ha', 'twin_blight_launchers_ha'],
  },
  {
    id: 'twin_plague_spewers_ha',
    name: 'Twin Plague Spewers',
    type: 'ranged',
    range: 10,
    cost: 45,
    handedness: 'two-handed',
    keywords: ['-1 INJURY DICE', 'FLAMETHROWER', 'IGNORE ARMOUR', 'AUTOMATIC 2', 'GAS', 'HEAVY', 'TWO-HANDED'],
    description: '10", -1 INJURY DICE, FLAMETHROWER, IGNORE ARMOUR, AUTOMATIC 2, GAS, HEAVY, TWO-HANDED. (+45cr) Foetid Blight-Drone Only.',
    conflictsWith: ['fleshmower_ha', 'twin_blight_launchers_ha'],
  },
  {
    id: 'twin_blight_launchers_ha',
    name: 'Twin Blight Launchers',
    type: 'ranged',
    range: 36,
    cost: 55,
    handedness: 'two-handed',
    keywords: ['+1 DICE', 'IGNORE COVER', 'BLAST 3"', 'HEAVY', 'TWO-HANDED', 'INFECTION MARKERS'],
    description: '36", +1 DICE, IGNORE COVER, BLAST 3", HEAVY, TWO-HANDED, INFECTION MARKERS. (+55cr) Foetid Blight-Drone Only.',
    conflictsWith: ['fleshmower_ha', 'twin_plague_spewers_ha'],
  },
...
export const necronsMeleeWeapons: Weapon[] = [
  ...
  { id: 'arrow_of_infinity_nec', name: 'Arrow of Infinity', type: 'ranged', range: 48, cost: 3, costCurrency: 'glory', limit: 1, keywords: ['IGNORE ARMOUR', '+1 INJURY DICE'], description: '48", IGNORE ARMOUR, +1 INJURY DICE. Can only be used once per battle. Takes up no hands. 3 Glory. LIMIT: 1. Necron Lord Only.', restrictedTo: ['ELITE'] },
  { id: 'conduit_of_stars_nec', name: 'Conduit of Stars', type: 'ranged', range: 24, cost: 6, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', 'ASSAULT', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '24", AUTOMATIC 2, ASSAULT, ARMOUR PIERCING 1, TWO-HANDED. 6 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'solar_staff_nec', name: 'Solar Staff', type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['HELD', 'MAIN HAND ONLY'], description: 'HELD, MAIN HAND ONLY. Strike: Melee, STUN. Blinding Lance: 18", STUN. Causes double STUN MARKERS. 2 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'voidreaper_nec', name: 'Voidreaper', type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'CUMBERSOME', 'TWO-HANDED'], description: 'Melee, +1 INJURY DICE, -DICE cannot be applied to injury rolls, CUMBERSOME, TWO-HANDED. If target has an armour modifier from any source other than a shield, set one die of the injury roll to 6 before rolling. 3 Glory. LIMIT: 1.' },
];
...
export const leaguesOfVotannRangedWeapons: Weapon[] = [
  ...
  // Unique Thrown
  {
    ...
    range: 8,
    cost: 10,
    keywords: ['IGNORE LONG RANGE', 'ASSAULT', 'ARMOUR PIERCING 1', 'FUMBLE', 'THROWN'],
    description: '8" IGNORE LONG RANGE, ASSAULT, ARMOUR PIERCING 1, FUMBLE, THROWN.',
  },
];
...
export const leaguesOfVotannMeleeWeapons: Weapon[] = [
  ...
  { id: 'exactor_votann', name: 'Exactor', type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY MODIFIER', 'IGNORE ARMOUR on Critical Hit', 'CRITICAL', 'HEAVY', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: 'Melee, +1 INJURY MODIFIER, IGNORE ARMOUR on Critical Hit, CRITICAL, HEAVY, ARMOUR PIERCING 1, TWO-HANDED. 3 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'forgestar_votann', name: 'Forgestar', type: 'ranged', range: 18, cost: 5, costCurrency: 'glory', limit: 1, keywords: ['-1 INJURY DICE', 'AUTOMATIC 3', 'ASSAULT', 'CRITICAL', 'PISTOL'], description: '18", -1 INJURY DICE, AUTOMATIC 3, ASSAULT, CRITICAL, PISTOL. 5 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'murmuring_stave_votann', name: 'Murmuring Stave', type: 'melee', cost: 4, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+1 INJURY DICE vs DAEMON/PSYKER', 'PSYCHIC', 'HELD', 'MAIN HAND ONLY'], description: 'Melee, +1 INJURY DICE against DAEMON or PSYKER targets, PSYCHIC, HELD, MAIN HAND ONLY. Choose a Skeinwrought power costing 5cr; the bearer knows and can use that power (does not count against Using Multiple Powers for the first use per Activation). 4 Glory. LIMIT: 1.' },
];
...
export const chaosCultWeapons: Weapon[] = [
  ...
  // ===================== Heretic Astartes Base Campaign Shop Weapons =====================
  { id: 'black_mace_ha', name: 'Black Mace', type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['SWEEPING', '+1 INJURY MODIFIER', 'HEAVY', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: 'Melee, SWEEPING, +1 INJURY MODIFIER, HEAVY, ARMOUR PIERCING 1, TWO-HANDED. 2 Glory. LIMIT: 1.' },
  { id: 'blade_of_the_relentless_ha', name: 'Blade of the Relentless', type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, keywords: ['VICIOUS 11', 'CRITICAL', 'ARMOUR PIERCING 2'], description: 'Melee, VICIOUS 11, CRITICAL, ARMOUR PIERCING 2. 3 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'foecleaver_ha', name: 'Foecleaver', type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', '+1 INJURY DICE vs IMPERIUM', 'ARMOUR PIERCING 2', 'HEAVY', 'TWO-HANDED'], description: 'Melee, +1 INJURY DICE, another +1 INJURY DICE against any model that is part of an Imperium Warband, ARMOUR PIERCING 2, HEAVY, TWO-HANDED. 2 Glory. LIMIT: 1. No Warband Variant Only, Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'orbs_of_unlife_ha', name: 'Orbs of Unlife', type: 'ranged', range: 8, cost: 3, costCurrency: 'glory', limit: 1, keywords: ['IGNORE ARMOUR', 'BLAST 3"', 'IGNORE COVER', 'IGNORE LONG RANGE', 'SCATTER'], description: '8", IGNORE ARMOUR, causes double BLOOD MARKERS, BLAST 3", IGNORE COVER, IGNORE LONG RANGE, SCATTER. 3 Glory. LIMIT: 1. Mark of Nurgle Only.' },
  { id: 'shadesword_ha', name: 'Shadesword', type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, keywords: ['ARMOUR PIERCING 2', 'PSYCHIC'], description: 'Melee, -DICE cannot be applied to Injury rolls caused by this weapon, ARMOUR PIERCING 2, PSYCHIC. 3 Glory. LIMIT: 1. Alpha Legion Only.' },
  { id: 'warps_malice_ha', name: "Warp's Malice", type: 'ranged', range: 12, cost: 3, costCurrency: 'glory', limit: 1, keywords: ['VICIOUS 11', 'ASSAULT', 'CRITICAL', 'PISTOL'], description: '12", VICIOUS 11, ASSAULT, CRITICAL, PISTOL, Scope Capable. On a hit, the wielder has +1 DICE to Hit with the next melee attack it makes against that same target during this Activation with another weapon. 3 Glory. LIMIT: 1.' },
  // ===================== Death Guard Campaign Shop Weapons =====================
  { id: 'plaguebringer_dg', name: 'Plaguebringer', type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'CRITICAL', 'HEAVY', 'TWO-HANDED', 'INFECTION MARKERS'], description: 'Melee, +1 INJURY DICE, CRITICAL, HEAVY, TWO-HANDED, INFECTION MARKERS. If an enemy is taken Out of Action by this weapon, that enemy\'s owner counts as having 1 fewer model for Morale until end of Turn. 3 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'plague_skull_dg', name: 'Plague Skull', type: 'ranged', range: 12, cost: 4, costCurrency: 'glory', limit: 1, keywords: ['AUTOMATIC 2', 'ASSAULT', 'GAS'], description: '12", AUTOMATIC 2, ASSAULT, GAS. 4 Glory. LIMIT: 1.' },
  { id: 'reaper_of_glorious_entropy_dg', name: 'Reaper of Glorious Entropy', type: 'melee', cost: 5, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+2 INJURY DICE', 'CRITICAL', 'HEAVY', 'IGNORE ARMOUR', 'TWO-HANDED', 'INFECTION MARKERS'], description: 'Melee, +2 INJURY DICE, CRITICAL, HEAVY, IGNORE ARMOUR, TWO-HANDED, INFECTION MARKERS. 5 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  // ===================== Thousand Sons Campaign Shop Weapons =====================
  { id: 'seers_bane_ts', name: "Seer's Bane", type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+1 INJURY DICE vs DAEMON/PSYKER', '+1 INJURY DICE vs PSYKER', 'PSYCHIC', 'ARMOUR PIERCING 2', 'HELD', 'MAIN HAND ONLY'], description: 'Melee, +1 INJURY DICE against targets with DAEMON or PSYKER Keyword, an additional +1 INJURY DICE against targets with PSYKER Keyword (total +2 INJURY DICE), PSYCHIC, ARMOUR PIERCING 2, HELD. 2 Glory. LIMIT: 1. Elite Psyker Only.', restrictedTo: ['ELITE'] },
  { id: 'stave_abominus_ts', name: 'Stave Abominus', type: 'melee', cost: 5, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['CLEAVE 2', '+1 INJURY DICE', '+1 INJURY DICE vs DAEMON/PSYKER', 'PSYCHIC', 'HELD', 'MAIN HAND ONLY'], description: 'Melee, CLEAVE 2, +1 INJURY DICE, +1 INJURY DICE against targets with DAEMON or PSYKER Keyword, PSYCHIC, HELD. 5 Glory. LIMIT: 1. Elite Psyker Only.', restrictedTo: ['ELITE'] },
  // ===================== World Eaters Campaign Shop Weapons =====================
  { id: 'bloodstep_blade_we', name: 'Bloodstep Blade', type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, keywords: ['+1 INJURY DICE', 'CRITICAL', 'HEAVY', 'DEEP STRIKE'], description: 'Melee, +1 INJURY DICE, CRITICAL, HEAVY. The equipped model gains the DEEP STRIKE Keyword. 3 Glory. LIMIT: 1.', grantsKeywords: ['DEEP STRIKE'] },
  { id: 'gorefather_we', name: 'Gorefather', type: 'melee', cost: 4, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['-1 DICE TO HIT', '+2 INJURY DICE', 'CRITICAL', 'HEAVY', 'RISKY', 'SHRAPNEL', 'TWO-HANDED'], description: 'Melee, -1 DICE to Hit, +2 INJURY DICE, CRITICAL, HEAVY, RISKY, SHRAPNEL, TWO-HANDED. 4 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'skullseeker_we', name: 'Skullseeker', type: 'ranged', range: 12, cost: 5, costCurrency: 'glory', limit: 1, keywords: ['VICIOUS 11', 'IGNORE ARMOUR', 'CRITICAL', 'PISTOL'], description: '12", VICIOUS 11, -DICE cannot be applied to the Injury roll, IGNORE ARMOUR, CRITICAL, PISTOL, Scope Capable. 5 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
];
...
export const adeptusMiniStorumWeapons: Weapon[] = [
  {
    ...
    isMainHandOnly: true,
    keywords: ['HELD', 'FIRE', '+1 INJURY DICE vs DAEMON/PSYKER', 'MAIN HAND ONLY'],
    description: 'HELD, FIRE. Strike: Melee, MAIN HAND ONLY. Unleash: 8" FLAMETHROWER, -1 INJURY DICE, IGNORE ARMOUR (once per battle). (Adeptus Ministorum)',
  },
  {
    id: 'dartmask_min',
    name: 'Dartmask',
...
export const officioAssassinorumWeapons: Weapon[] = [
  ...
  // Thrown
  {
    ...
    range: 8,
    cost: 25,
    keywords: ['IGNORE ARMOUR', 'ASSAULT', 'BLAST 3"', 'FUMBLE', 'GAS', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'],
    description: '8", IGNORE ARMOUR, ASSAULT, BLAST 3", FUMBLE, GAS, IGNORE COVER, IGNORE LONG RANGE, THROWN. (Venenum Only)',
  },
  {
...
export const vermintideWeapons: Weapon[] = [
  ...
  // Thrown
  {
    ...
    range: 6,
    cost: 15,
    keywords: ['ASSAULT', 'BLAST 2"', 'FIRE', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'RISKY', 'THROWN'],
    description: '6", ASSAULT, BLAST 2", FIRE, FUMBLE, IGNORE COVER, IGNORE LONG RANGE, RISKY, THROWN.',
  },
  {
    id: 'poison_stars_ver',
    name: 'Poison Stars',
...
export const adeptusMechanicusWeapons: Weapon[] = [
  ...
  },
  {
    ...
    handedness: 'two-handed',
    keywords: ['ARMOUR PIERCING 1', 'TWO-HANDED'],
    description: '30", TWO-HANDED. Normal: ARMOUR PIERCING 1. Overload: +1 INJURY DICE, ARMOUR PIERCING 2, RISKY. LIMIT: 1. Elite Only.',
  },
  {
...
export const adeptusCustodesWeapons: Weapon[] = [
  ...
  // Melee
  {
    ...
    cost: 15,
    handedness: 'two-handed',
    keywords: ['+1 INJURY DICE', '+1 INJURY DICE vs DAEMON/PSYKER', 'CRITICAL', 'TWO-HANDED'],
    description: 'Melee, +1 INJURY DICE (+1 more vs DAEMON/PSYKER), CRITICAL, TWO-HANDED. Anathema Only.',
    restrictedTo: ['ANATHEMA'],
  },
  {
  ...
  // Combined weapons (ranged+melee)
  {
    ...
    cost: 50,
    handedness: 'two-handed',
    keywords: ['BLOCK', 'HEAVY', 'HELD', 'CUMBERSOME', '+1 INJURY DICE', 'IGNORE ARMOUR', 'TWO-HANDED'],
    description: 'BLOCK, HEAVY, HELD, TWO-HANDED. Strike: Melee, CUMBERSOME, +1 INJURY DICE (+1 if Charged) IGNORE ARMOUR. Shoot: 12" +2 INJURY DICE at Short Range. Contemptor Only.',
  },
  {
    id: 'adrasite_spear',
    name: 'Adrasite Spear',
  ...
  // Campaign Shop Weapons
  { id: 'apollonian_spear_custodes', name: 'Apollonian Spear', type: 'melee', cost: 4, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['BLOCK', 'HEAVY', 'TWO-HANDED'], description: 'BLOCK, HEAVY. Injury rolls cannot benefit from any -DICE, TWO-HANDED, Shield Combo. Strike: Melee, CUMBERSOME, CLEAVE 2. Shoot: 18", ARMOUR PIERCING 2. 4 Glory. LIMIT: 1.' },
  { id: 'auriferous_orbs_custodes', name: 'Auriferous Orbs', type: 'ranged', range: 8, cost: 3, costCurrency: 'glory', limit: 1, keywords: ['ASSAULT', 'BLAST 3"', 'IGNORE COVER', 'IGNORE LONG RANGE', 'IGNORE ARMOUR', 'THROWN', 'FUMBLE'], description: '8", ASSAULT, BLAST 3", IGNORE COVER, IGNORE LONG RANGE, IGNORE ARMOUR, THROWN, FUMBLE. On a hit, target suffers -1 DICE to all of its attacks during its next Activation. 3 Glory. LIMIT: 1.' },
  { id: 'sword_of_oblivion_custodes', name: 'Sword of Oblivion', type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['CRITICAL', '+1 INJURY DICE', '+1 INJURY DICE vs DAEMON/PSYKER', 'ARMOUR PIERCING 2', 'TWO-HANDED'], description: 'Melee, CRITICAL, +1 INJURY DICE, another +1 INJURY DICE against targets with DAEMON or PSYKER Keyword, ARMOUR PIERCING 2, TWO-HANDED. 3 Glory. LIMIT: 1.' },
];
...
export const drukahriWeapons: Weapon[] = [
  // Ranged
  { id: 'blaster_drukhari', name: 'Blaster', type: 'ranged', range: 18, cost: 25, limit: 2, handedness: 'two-handed', keywords: ['IGNORE ARMOUR', 'ASSAULT', 'TWO-HANDED'], description: '18", IGNORE ARMOUR, ASSAULT, TWO-HANDED. LIMIT: 2.' },
  { id: 'hexrifle_drukhari', name: 'Hexrifle', type: 'ranged', range: 36, cost: 25, limit: 2, handedness: 'two-handed', keywords: ['IGNORE -DICE INJURY', 'INFECTION MARKERS', 'TWO-HANDED'], description: '36", Ignores -DICE to Injury Rolls, INFECTION MARKERS, TWO-HANDED. LIMIT: 2. Haemonculus or Wrack Only.' },
  { id: 'liquifier_gun_drukhari', name: 'Liquifier Gun', type: 'ranged', range: 8, cost: 25, limit: 1, handedness: 'two-handed', keywords: ['FLAMETHROWER', 'IGNORE ARMOUR', '-1 INJURY DICE', 'GAS', 'TWO-HANDED'], description: '8", FLAMETHROWER, IGNORE ARMOUR, -1 INJURY DICE, GAS, TWO-HANDED. LIMIT: 1.' },
  { id: 'ossefactor_drukhari', name: 'Ossefactor', type: 'ranged', range: 24, cost: 20, handedness: 'two-handed', keywords: ['CRITICAL', 'ARMOUR PIERCING 2', 'TWO-HANDED'], description: '24", CRITICAL, ARMOUR PIERCING 2, TWO-HANDED. On Critical Hit, gains BLAST 2". Haemonculus or Wrack Only.' },
  { id: 'shredder_drukhari', name: 'Shredder', type: 'ranged', range: 8, cost: 25, limit: 2, handedness: 'two-handed', keywords: ['FLAMETHROWER', 'IGNORE ARMOUR', '-1 INJURY DICE', 'SHRAPNEL', 'TWO-HANDED'], description: '8", FLAMETHROWER, IGNORE ARMOUR, -1 INJURY DICE, SHRAPNEL, TWO-HANDED. LIMIT: 2.' },
  { id: 'spirit_syphon_drukhari', name: 'Spirit Syphon', type: 'ranged', range: 10, cost: 30, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '-1 INJURY DICE', 'FLAMETHROWER', 'IGNORE ARMOUR', 'HEAVY', 'TWO-HANDED'], description: '10", AUTOMATIC 2, -1 INJURY DICE, FLAMETHROWER, IGNORE ARMOUR, HEAVY, TWO-HANDED. Cronos Only.' },
  { id: 'spirit_vortex_drukhari', name: 'Spirit Vortex', type: 'ranged', range: 18, cost: 15, handedness: 'two-handed', keywords: ['IGNORE COVER', 'BLAST 3"', 'HEAVY', 'TWO-HANDED'], description: '18", IGNORE COVER, BLAST 3", HEAVY, TWO-HANDED. Cronos Only.' },
  { id: 'splinter_rifle_drukhari', name: 'Splinter Rifle', type: 'ranged', range: 24, cost: 15, handedness: 'two-handed', keywords: ['SHRAPNEL', 'TWO-HANDED'], description: '24", SHRAPNEL, TWO-HANDED.' },
  { id: 'splinter_pods_drukhari', name: 'Splinter Pods', type: 'ranged', range: 18, cost: 20, handedness: 'two-handed', keywords: ['ASSAULT', 'SHRAPNEL', 'TWO-HANDED'], description: '18", ASSAULT, SHRAPNEL, TWO-HANDED. Take up no hands. Hellion Skyboard Only.' },
  { id: 'terrorfex_drukhari', name: 'Terrorfex', type: 'ranged', range: 24, cost: 40, limit: 1, keywords: ['IGNORE COVER'], description: '24", IGNORE COVER. Takes no hands. Xenospasm: BLAST 3", SHRAPNEL. Wraithbone: target moves D3" away on a hit. LIMIT: 1.' },
  { id: 'twin_haywire_blaster_drukhari', name: 'Twin Haywire Blaster', type: 'ranged', range: 24, cost: 35, limit: 1, handedness: 'two-handed', keywords: ['+1 DICE', 'IGNORE COVER', '+1 INJURY DICE vs ARTIFICIAL/VEHICLE', '-1 INJURY DICE vs others', 'BLAST 3"', 'HEAVY', 'STUN', 'TWO-HANDED'], description: '24", +1 DICE, IGNORE COVER, +1 INJURY DICE vs ARTIFICIAL/VEHICLE (instead of -1 vs others), BLAST 3", HEAVY, STUN, TWO-HANDED. LIMIT: 1. Talos Only.' },
  { id: 'twin_heat_lance_drukhari', name: 'Twin Heat Lance', type: 'ranged', range: 18, cost: 150, limit: 1, handedness: 'two-handed', keywords: ['+1 DICE', '+1 INJURY DICE', 'IGNORE ARMOUR', 'HEAVY', 'RISKY', 'TWO-HANDED'], description: '18", +1 DICE, +1 INJURY DICE, IGNORE ARMOUR, HEAVY, RISKY, TWO-HANDED. 5 Glory. LIMIT: 1. Talos Only.' },
  { id: 'twin_liquifier_gun_drukhari', name: 'Twin Liquifier Gun', type: 'ranged', range: 10, cost: 45, limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', 'FLAMETHROWER', 'IGNORE ARMOUR', '-1 INJURY DICE', 'GAS', 'HEAVY', 'TWO-HANDED'], description: '10", AUTOMATIC 2, FLAMETHROWER, IGNORE ARMOUR, -1 INJURY DICE, GAS, HEAVY, TWO-HANDED. LIMIT: 1. Talos Only.' },
  { id: 'twin_splinter_cannon_drukhari', name: 'Twin Splinter Cannon', type: 'ranged', range: 36, cost: 55, limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '+1 DICE', 'HEAVY', 'SHRAPNEL'], description: '36", AUTOMATIC 2, +1 DICE, HEAVY, SHRAPNEL. LIMIT: 1. Talos Only.' },
  // Pistols
  { id: 'blast_pistol_drukhari', name: 'Blast Pistol', type: 'ranged', range: 6, cost: 20, limit: 2, keywords: ['IGNORE ARMOUR', 'PISTOL'], description: '6", IGNORE ARMOUR, PISTOL. LIMIT: 2. Elite or Wych Only.', restrictedTo: ['ELITE'] },
  { id: 'splinter_pistol_drukhari', name: 'Splinter Pistol', type: 'ranged', range: 12, cost: 12, keywords: ['SHRAPNEL', 'PISTOL', 'MAIN HAND ONLY'], description: '12", SHRAPNEL, PISTOL, MAIN HAND ONLY.' },
  { id: 'stinger_pistol_drukhari', name: 'Stinger Pistol', type: 'ranged', range: 12, cost: 12, keywords: ['GAS', 'PISTOL', 'MAIN HAND ONLY'], description: '12", GAS, PISTOL, MAIN HAND ONLY.' },
  // Heavy Ranged
  { id: 'dark_lance_drukhari', name: 'Dark Lance', type: 'ranged', range: 36, cost: 90, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'HEAVY', 'TWO-HANDED'], description: '36", +1 INJURY DICE, IGNORE ARMOUR, HEAVY, TWO-HANDED. 3 Glory. LIMIT: 1.' },
  { id: 'heat_lance_drukhari', name: 'Heat Lance', type: 'ranged', range: 18, cost: 90, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'FIRE', 'IGNORE ARMOUR', 'HEAVY', 'RISKY', 'TWO-HANDED'], description: '18", +1 INJURY DICE, FIRE, IGNORE ARMOUR, HEAVY, RISKY, TWO-HANDED. 3 Glory. LIMIT: 1.' },
  { id: 'splinter_cannon_drukhari', name: 'Splinter Cannon', type: 'ranged', range: 36, cost: 45, limit: 2, handedness: 'two-handed', keywords: ['AUTOMATIC 2', 'HEAVY', 'SHRAPNEL', 'TWO-HANDED'], description: '36", AUTOMATIC 2, HEAVY, SHRAPNEL, TWO-HANDED. LIMIT: 2.' },
  // Melee
  ...
  { id: 'demiklaives_drukhari', name: 'Demiklaives', type: 'melee', cost: 20, handedness: 'two-handed', keywords: ['CRITICAL', 'CUMBERSOME', 'TWO-HANDED'], description: 'Melee, CRITICAL, CUMBERSOME, TWO-HANDED. Single Blade: +1 INJURY DICE. Dual Blades: CLEAVE 2. Elite or Incubus Only.', restrictedTo: ['ELITE'] },
  { id: 'hekatarii_blade_drukhari', name: 'Hekatarii Blade', type: 'melee', cost: 3, keywords: [], description: 'Melee.' },
  { id: 'hellglaive_drukhari', name: 'Hellglaive', type: 'melee', cost: 20, limit: 2, handedness: 'two-handed', keywords: ['HELD', 'BLOCK', 'TWO-HANDED'], description: 'HELD, BLOCK, TWO-HANDED, Shield Combo. Strike: Melee. Shoot: 24", SHRAPNEL. LIMIT: 2.' },
  ...
  { id: 'spirit_leech_tentacles_drukhari', name: 'Spirit-Leech Tentacles', type: 'melee', cost: 12, handedness: 'two-handed', keywords: ['CLEAVE 2', 'CUMBERSOME', 'TWO-HANDED', 'HEAVY'], description: 'Melee, CLEAVE 2, CUMBERSOME, TWO-HANDED, HEAVY. Enemies cannot Retreat from the wielder. Cronos Only.' },
  { id: 'spirit_probe_drukhari', name: 'Spirit Probe', type: 'melee', cost: 15, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'CUMBERSOME', 'HEAVY', 'TWO-HANDED'], description: 'Melee, +1 INJURY DICE, CUMBERSOME, HEAVY, TWO-HANDED. Gain 1 additional Pain token on a hit. Cronos Only.' },
  ...
  { id: 'torturers_tools_drukhari', name: "Torturer's Tools", type: 'melee', cost: 23, handedness: 'two-handed', keywords: ['+1 DICE', 'CUMBERSOME', 'TWO-HANDED'], description: "Melee, +1 DICE, causes 1 additional BLOOD MARKER if it causes any BLOOD MARKERS, CUMBERSOME, TWO-HANDED. Haemonculus, Talos, or Wrack Only." },
  // Thrown
  { id: 'haywire_grenades_drukhari', name: 'Haywire Grenades', type: 'ranged', range: 8, cost: 17, keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', 'ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'STUN', 'THROWN'], description: '8", IGNORE ARMOUR, -1 INJURY DICE non-ARTIFICIAL/VEHICLE, ASSAULT, BLAST 3", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, STUN, THROWN.' },
  { id: 'plasma_grenade_drukhari', name: 'Plasma Grenade', type: 'ranged', range: 8, cost: 20, keywords: ['ASSAULT', 'BLAST 2"', 'FIRE', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'], description: '8", ASSAULT, BLAST 2", FIRE, FUMBLE, IGNORE COVER, IGNORE LONG RANGE, THROWN.' },
  { id: 'xenospasm_grenades_drukhari', name: 'Xenospasm Grenades', type: 'ranged', range: 8, cost: 18, keywords: ['ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'SHRAPNEL', 'THROWN'], description: '8", ASSAULT, BLAST 3", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, SHRAPNEL, THROWN.' },
  { id: 'wraithbone_grenades_drukhari', name: 'Wraithbone Grenades', type: 'ranged', range: 8, cost: 10, limit: 3, keywords: ['ASSAULT', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'], description: '8", ASSAULT, IGNORE COVER, IGNORE LONG RANGE, THROWN. Target moves D3" away on a hit unless unaffected by FEAR. LIMIT: 3.' },
  { id: 'soulshard_grenades_drukhari', name: 'Soulshard Grenade', type: 'ranged', range: 8, cost: 3, costCurrency: 'glory', limit: 1, keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', '+1 INJURY DICE vs DAEMON/PSYKER', 'BLAST 2"', 'IGNORE COVER', 'IGNORE LONG RANGE', 'ASSAULT', 'STUN', 'THROWN', 'FUMBLE'], description: '8", IGNORE ARMOUR, -1 INJURY DICE, +1 INJURY DICE against targets with DAEMON or PSYKER Keyword, BLAST 2", IGNORE COVER, IGNORE LONG RANGE, ASSAULT, STUN, THROWN, FUMBLE. Can only be used once per battle. 3 Glory. LIMIT: 1.' },
  // Campaign Shop Weapons
  { id: 'animus_vitae_drukhari', name: 'Animus Vitae', type: 'ranged', range: 6, cost: 3, costCurrency: 'glory', limit: 1, keywords: ['IGNORE ARMOUR', 'BLAST 3"', 'SCATTER', 'THROWN'], description: '6", IGNORE ARMOUR, BLAST 3", SCATTER, THROWN. Can only be used once per battle. 3 Glory. LIMIT: 1.' },
  { id: 'djin_blade_drukhari', name: 'Djin Blade', type: 'melee', cost: 8, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['CLEAVE 2', '+2 INJURY DICE', 'CRITICAL', 'TWO-HANDED'], description: 'Melee, CLEAVE 2, +2 INJURY DICE, CRITICAL, TWO-HANDED. 8 Glory. LIMIT: 1. Archon Only.', restrictedTo: ['ELITE'] },
  { id: 'parasite_kiss_drukhari', name: "Parasite's Kiss", type: 'ranged', range: 12, cost: 4, costCurrency: 'glory', limit: 1, keywords: ['ASSAULT', 'GAS', 'SHRAPNEL', 'PISTOL'], description: '12", ASSAULT, GAS, SHRAPNEL, PISTOL. 4 Glory. LIMIT: 1.' },
  { id: 'tormentrix_drukhari', name: 'Tormentrix', type: 'melee', cost: 4, costCurrency: 'glory', limit: 1, keywords: ['CRITICAL', 'GAS', 'ARMOUR PIERCING 2'], description: 'Melee, CRITICAL, GAS, ARMOUR PIERCING 2. 4 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'triptych_whip_drukhari', name: 'Triptych Whip', type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['CRITICAL', 'GAS', 'ARMOUR PIERCING 1', 'WHIP 3"', 'MAIN HAND ONLY'], description: 'Melee, CRITICAL, GAS, ARMOUR PIERCING 1, WHIP 3", MAIN HAND ONLY. 2 Glory. LIMIT: 1. Succubus Only.', restrictedTo: ['ELITE'] },
];
...
export const aeldariWeapons: Weapon[] = [
  // Ranged
  { id: 'avenger_shuriken_catapult', name: 'Avenger Shuriken Catapult', type: 'ranged', range: 18, cost: 35, limit: 2, handedness: 'two-handed', keywords: ['AUTOMATIC 2', 'ASSAULT', 'ARMOUR PIERCING 1 on Critical Hit', 'TWO-HANDED'], description: '18", AUTOMATIC 2, ASSAULT, ARMOUR PIERCING 1 on Critical Hit, TWO-HANDED. LIMIT: 2. Elite or Dire Avenger Only.', restrictedTo: ['ELITE'] },
  { id: 'cloudsweeper_aeldari', name: 'Cloudsweeper', type: 'ranged', range: 24, cost: 35, limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', 'ASSAULT', 'CRITICAL', 'TWO-HANDED'], description: '24", AUTOMATIC 2, ASSAULT, CRITICAL, TWO-HANDED. LIMIT: 1. Swooping Hawk Only.' },
  { id: 'death_spinner_aeldari', name: 'Death Spinner', type: 'ranged', range: 12, cost: 20, limit: 2, handedness: 'two-handed', keywords: ['BLAST 2"', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '12", BLAST 2", ARMOUR PIERCING 1, TWO-HANDED. LIMIT: 2. Elite or Warp Spider Only.', restrictedTo: ['ELITE'] },
  { id: 'dragon_fusion_gun', name: 'Dragon Fusion Gun', type: 'ranged', range: 12, cost: 35, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'TWO-HANDED'], description: '12", +1 INJURY DICE, IGNORE ARMOUR, TWO-HANDED. LIMIT: 1. Elite or Fire Dragon Only.', restrictedTo: ['ELITE'] },
  { id: 'dragons_breath_flamer', name: "Dragon's Breath Flamer", type: 'ranged', range: 10, cost: 55, limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '-1 INJURY DICE', 'FLAMETHROWER', 'IGNORE ARMOUR', 'FIRE', 'TWO-HANDED'], description: '10", AUTOMATIC 2, -1 INJURY DICE, FLAMETHROWER, IGNORE ARMOUR, FIRE, TWO-HANDED. LIMIT: 1. Fire Dragon Only.' },
  { id: 'firepike_aeldari', name: 'Firepike', type: 'ranged', range: 16, cost: 40, limit: 1, handedness: 'two-handed', keywords: ['FLAMETHROWER', 'IGNORE ARMOUR', '-1 INJURY DICE', 'FIRE', 'TWO-HANDED'], description: '16", FLAMETHROWER, IGNORE ARMOUR, -1 INJURY DICE, FIRE, TWO-HANDED. LIMIT: 1. Elite or Fire Dragon Only.', restrictedTo: ['ELITE'] },
  { id: 'hawks_talon', name: "Hawk's Talon", type: 'ranged', range: 24, cost: 40, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'CRITICAL', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '24", +1 INJURY DICE, CRITICAL, ARMOUR PIERCING 1, TWO-HANDED. LIMIT: 1. Swooping Hawk Only.' },
  { id: 'lasblaster_aeldari', name: 'Lasblaster', type: 'ranged', range: 24, cost: 30, limit: 2, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'CRITICAL', 'TWO-HANDED'], description: '24", +1 INJURY DICE, CRITICAL, TWO-HANDED. LIMIT: 2. Elite or Swooping Hawk Only.', restrictedTo: ['ELITE'] },
  { id: 'long_rifle_aeldari', name: 'Long Rifle', type: 'ranged', range: 48, cost: 40, limit: 2, handedness: 'two-handed', keywords: ['+1 DICE', 'CRITICAL', 'TWO-HANDED'], description: '48", +1 DICE, CRITICAL, TWO-HANDED. LIMIT: 2.' },
  { id: 'shuriken_catapult', name: 'Shuriken Catapult', type: 'ranged', range: 18, cost: 10, handedness: 'two-handed', keywords: ['ARMOUR PIERCING 1 on Critical Hit', 'TWO-HANDED'], description: '18", ARMOUR PIERCING 1 on Critical Hit, TWO-HANDED.' },
  { id: 'shuriken_rifle', name: 'Shuriken Rifle', type: 'ranged', range: 24, cost: 12, handedness: 'two-handed', keywords: ['ARMOUR PIERCING 1 on Critical Hit', 'TWO-HANDED'], description: '24", ARMOUR PIERCING 1 on Critical Hit, TWO-HANDED.' },
  { id: 'spinneret_rifle', name: 'Spinneret Rifle', type: 'ranged', range: 18, cost: 20, limit: 1, handedness: 'two-handed', keywords: ['IGNORE ARMOUR', 'TWO-HANDED'], description: '18", IGNORE ARMOUR, TWO-HANDED. LIMIT: 1. Warp Spider Only.' },
  // Pistols
  { id: 'death_weavers', name: 'Death Weavers', type: 'ranged', range: 6, cost: 20, keywords: ['BLAST 2"', 'ARMOUR PIERCING 1', 'PISTOL'], description: '6", BLAST 2", ARMOUR PIERCING 1, PISTOL. Comes as a pair; attack with each on Shoot. Elite or Warp Spider Only.', restrictedTo: ['ELITE'] },
  { id: 'dragon_fusion_pistol', name: 'Dragon Fusion Pistol', type: 'ranged', range: 6, cost: 30, keywords: ['IGNORE ARMOUR', 'PISTOL'], description: '6", IGNORE ARMOUR, PISTOL. 1 Glory. Elite or Fire Dragon Only.', restrictedTo: ['ELITE'] },
  { id: 'shuriken_pistol', name: 'Shuriken Pistol', type: 'ranged', range: 12, cost: 7, keywords: ['ARMOUR PIERCING 1 on Critical Hit', 'PISTOL'], description: '12", ARMOUR PIERCING 1 on Critical Hit, PISTOL.' },
  { id: 'sunpistol_aeldari', name: 'Sunpistol', type: 'ranged', range: 12, cost: 12, keywords: ['ASSAULT', 'CRITICAL', 'PISTOL'], description: '12", ASSAULT, CRITICAL, PISTOL. Elite or Swooping Hawk Only.', restrictedTo: ['ELITE'] },
  { id: 'twin_shuriken_pistols', name: 'Twin Shuriken Pistols', type: 'ranged', range: 12, cost: 12, limit: 2, handedness: 'two-handed', keywords: ['+1 DICE', 'ARMOUR PIERCING 1 on Critical Hit', 'CUMBERSOME', 'TWO-HANDED', 'PISTOL'], description: '12", +1 DICE, ARMOUR PIERCING 1 on Critical Hit, CUMBERSOME, TWO-HANDED, PISTOL. LIMIT: 2.' },
  // Heavy Ranged
  { id: 'bright_lance_aeldari', name: 'Bright Lance', type: 'ranged', range: 36, cost: 35, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'HEAVY', 'TWO-HANDED'], description: '36", +1 INJURY DICE, HEAVY, TWO-HANDED. LIMIT: 1.' },
  { id: 'distortion_scythe', name: 'Distortion Scythe', type: 'ranged', range: 10, cost: 120, limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '+1 INJURY DICE', 'FLAMETHROWER', 'IGNORE ARMOUR', 'HEAVY', 'PSYCHIC', 'TWO-HANDED'], description: '10", AUTOMATIC 2, +1 INJURY DICE, FLAMETHROWER, IGNORE ARMOUR, HEAVY, PSYCHIC, TWO-HANDED. 4 Glory. LIMIT: 1. Wraith Only.' },
  { id: 'reaper_launcher', name: 'Reaper Launcher', type: 'ranged', range: 48, cost: 45, limit: 2, handedness: 'two-handed', keywords: ['IGNORE COVER', 'HEAVY', 'TWO-HANDED'], description: '48", IGNORE COVER, HEAVY, TWO-HANDED. LIMIT: 2. Starshot: +1 INJURY DICE. Starswarm: BLAST 2", SHRAPNEL. Dark Reaper or Wraith Only.' },
  { id: 'scatter_laser', name: 'Scatter Laser', type: 'ranged', range: 36, cost: 30, limit: 2, handedness: 'two-handed', keywords: ['AUTOMATIC 2', 'HEAVY', 'TWO-HANDED'], description: '36", AUTOMATIC 2, HEAVY, TWO-HANDED. LIMIT: 2.' },
  { id: 'shuriken_cannon', name: 'Shuriken Cannon', type: 'ranged', range: 24, cost: 35, limit: 3, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'HEAVY', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '24", +1 INJURY DICE, HEAVY, ARMOUR PIERCING 1, TWO-HANDED. LIMIT: 3.' },
  { id: 'starcannon', name: 'Starcannon', type: 'ranged', range: 36, cost: 120, limit: 1, handedness: 'two-handed', keywords: ['+2 INJURY DICE', 'ARMOUR PIERCING 2', 'HEAVY', 'TWO-HANDED'], description: '36", +2 INJURY DICE, ARMOUR PIERCING 2, HEAVY, TWO-HANDED. 4 Glory. LIMIT: 1.' },
  { id: 'tempest_launcher', name: 'Tempest Launcher', type: 'ranged', range: 36, cost: 45, limit: 1, handedness: 'two-handed', keywords: ['IGNORE COVER', 'BLAST 4"', 'HEAVY', 'SHRAPNEL', 'TWO-HANDED'], description: '36", IGNORE COVER, BLAST 4", HEAVY, SHRAPNEL, TWO-HANDED. LIMIT: 1. Dark Reaper or Wraith Only.' },
  { id: 'twin_shuriken_catapult', name: 'Twin Shuriken Catapult', type: 'ranged', range: 18, cost: 15, handedness: 'two-handed', keywords: ['+1 DICE', 'HEAVY', 'ARMOUR PIERCING 1 on Critical Hit', 'TWO-HANDED'], description: '18", +1 DICE, HEAVY, ARMOUR PIERCING 1 on Critical Hit, TWO-HANDED.' },
  { id: 'wraithcannon', name: 'Wraithcannon', type: 'ranged', range: 18, cost: 30, handedness: 'two-handed', keywords: ['+2 INJURY DICE', 'HEAVY', 'TWO-HANDED'], description: '18", +2 INJURY DICE, HEAVY, TWO-HANDED. Wraith Only.' },
  // Melee
  ...
  { id: 'power_blade_aeldari', name: 'Power Blade', type: 'melee', cost: 17, limit: 3, isMainHandOnly: true, keywords: ['CRITICAL', 'ARMOUR PIERCING 2', 'MAIN HAND ONLY'], description: 'Melee, CRITICAL, ARMOUR PIERCING 2, MAIN HAND ONLY. LIMIT: 3. Elite Only.', restrictedTo: ['ELITE'] },
  ...
  { id: 'paired_chainsabres', name: 'Paired Chainsabres', type: 'melee', cost: 40, limit: 1, keywords: ['HELD', 'ARMOUR PIERCING 1 on Critical Hit'], description: 'Comes as pair, HELD. Strike: Melee, IGNORE OFF-HAND, CRITICAL, RISKY, SHRAPNEL. Shoot: 12", ARMOUR PIERCING 1 on Critical Hit. LIMIT: 1. Elite or Striking Scorpion Only.', restrictedTo: ['ELITE'] },
  { id: 'scorpions_claw', name: "Scorpion's Claw", type: 'melee', cost: 25, limit: 1, keywords: ['HELD', 'ARMOUR PIERCING 1 on Critical Hit'], description: 'HELD. Strike: Melee, ARMOUR PIERCING 2. Shoot: 12", ASSAULT, ARMOUR PIERCING 1 on Critical Hit. LIMIT: 1. Striking Scorpion Only.' },
  ...
  // Thrown
  { id: 'haywire_grenades_aeldari', name: 'Haywire Grenades', type: 'ranged', range: 8, cost: 17, limit: 2, keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', 'ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'STUN', 'THROWN'], description: '8", IGNORE ARMOUR, -1 INJURY DICE non-ARTIFICIAL/VEHICLE, ASSAULT, BLAST 3", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, STUN, THROWN. LIMIT: 2.' },
  { id: 'melta_bombs_aeldari', name: 'Melta Bombs', type: 'ranged', range: 6, cost: 20, limit: 1, keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'ASSAULT', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'RISKY', 'THROWN'], description: '6", +1 INJURY DICE, IGNORE ARMOUR, ASSAULT, FUMBLE, IGNORE COVER, IGNORE LONG RANGE, RISKY, THROWN. LIMIT: 1. Fire Dragon Only.' },
  { id: 'plasma_grenades_aeldari', name: 'Plasma Grenades', type: 'ranged', range: 8, cost: 20, keywords: ['ASSAULT', 'BLAST 2"', 'FIRE', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'], description: '8", ASSAULT, BLAST 2", FIRE, FUMBLE, IGNORE COVER, IGNORE LONG RANGE, THROWN.' },
  { id: 'triskeles', name: 'Triskeles', type: 'ranged', range: 12, cost: 10, keywords: ['IGNORE LONG RANGE', 'ASSAULT', 'CRITICAL', 'THROWN'], description: '12", IGNORE LONG RANGE, ASSAULT, CRITICAL, THROWN.' },
  // Campaign Shop Weapons
  { id: 'avenging_blade_aeldari', name: 'Avenging Blade', type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'MAIN HAND ONLY'], description: 'Melee, +1 INJURY DICE, IGNORE ARMOUR, MAIN HAND ONLY. 3 Glory. LIMIT: 1. Elite Dire Avenger Only.', restrictedTo: ['ELITE'] },
  { id: 'exile_glaive_aeldari', name: 'Exile Glaive', type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'BLOCK', 'ARMOUR PIERCING 2', 'TWO-HANDED'], description: 'Melee, +1 INJURY DICE, BLOCK, ARMOUR PIERCING 2, TWO-HANDED, Shield Combo. 3 Glory. LIMIT: 1. Elite or Ranger Only.', restrictedTo: ['ELITE'] },
  { id: 'firesabre_aeldari', name: 'Firesabre', type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+1 INJURY DICE', 'CRITICAL', 'FIRE', 'MAIN HAND ONLY'], description: 'Melee, +1 INJURY DICE, CRITICAL, FIRE, MAIN HAND ONLY. 2 Glory. LIMIT: 1.' },
  { id: 'shard_of_anaris_aeldari', name: 'Shard of Anaris', type: 'melee', cost: 5, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['CLEAVE 3', 'CRITICAL', 'MAIN HAND ONLY'], description: 'Melee, CLEAVE 3, CRITICAL, MAIN HAND ONLY. 5 Glory. LIMIT: 1.' },
  { id: 'shadowsting_aeldari', name: 'Shadowsting', type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'CRITICAL', 'ARMOUR PIERCING 1', 'RISKY', 'SHRAPNEL', 'TWO-HANDED'], description: 'Melee, +1 INJURY DICE, CRITICAL, ARMOUR PIERCING 1, RISKY, SHRAPNEL, TWO-HANDED. 2 Glory. LIMIT: 1. Elite Striking Scorpion Only.', restrictedTo: ['ELITE'] },
  { id: 'spiders_bite_aeldari', name: "Spider's Bite", type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'CRITICAL', 'ARMOUR PIERCING 2', 'TWO-HANDED'], description: 'Melee, +1 INJURY DICE, CRITICAL, ARMOUR PIERCING 2, TWO-HANDED. 2 Glory. LIMIT: 1. Elite Warp Spider Only.', restrictedTo: ['ELITE'] },
];
...
export const harlequinsWeapons: Weapon[] = [
  // Ranged
  { id: 'hallucinogen_grenade_launcher', name: 'Hallucinogen Grenade Launcher', type: 'ranged', range: 18, cost: 25, limit: 2, handedness: 'two-handed', keywords: ['BLAST 3"', 'TWO-HANDED'], description: '18", BLAST 3", TWO-HANDED. Hit targets must move D3" in direction of opponent\'s choice. LIMIT: 2.' },
  // Pistols
  { id: 'fusion_pistol_harlequins', name: 'Fusion Pistol', type: 'ranged', range: 6, cost: 25, limit: 2, keywords: ['IGNORE ARMOUR', 'RISKY', 'PISTOL'], description: '6", IGNORE ARMOUR, RISKY, PISTOL. LIMIT: 2.' },
  { id: 'harlequins_caress', name: "Harlequin's Caress", type: 'ranged', range: 6, cost: 25, limit: 3, keywords: ['FLAMETHROWER', 'ASSAULT', 'PISTOL'], description: "6\", FLAMETHROWER, ASSAULT, PISTOL. Loses FLAMETHROWER in melee. LIMIT: 3." },
  { id: 'neuro_disruptor_harlequins', name: 'Neuro Disruptor', type: 'ranged', range: 12, cost: 30, limit: 1, keywords: ['-1 INJURY DICE', 'IGNORE ARMOUR', 'ASSAULT', 'STUN', 'PISTOL'], description: '12", -1 INJURY DICE, IGNORE ARMOUR, ASSAULT, STUN, PISTOL. LIMIT: 1. Elite Psyker Only.' },
  // Heavy Ranged
  { id: 'bright_lance_harlequins', name: 'Bright Lance', type: 'ranged', range: 36, cost: 35, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'HEAVY', 'TWO-HANDED'], description: '36", +1 INJURY DICE, HEAVY, TWO-HANDED. LIMIT: 1.' },
  { id: 'haywire_cannon_harlequins', name: 'Haywire Cannon', type: 'ranged', range: 24, cost: 20, limit: 1, handedness: 'two-handed', keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', 'HEAVY', 'STUN', 'TWO-HANDED'], description: '24", IGNORE ARMOUR, -1 INJURY DICE non-ARTIFICIAL/VEHICLE, HEAVY, STUN, TWO-HANDED. LIMIT: 1.' },
  { id: 'prismatic_cannon', name: 'Prismatic Cannon', type: 'ranged', range: 36, cost: 90, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'HEAVY', 'TWO-HANDED'], description: '36", +1 INJURY DICE, IGNORE ARMOUR, HEAVY, TWO-HANDED. 3 Glory. LIMIT: 1.' },
  { id: 'shrieker_cannon', name: 'Shrieker Cannon', type: 'ranged', range: 24, cost: 45, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'GAS', 'HEAVY', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '24", +1 INJURY DICE, GAS, HEAVY, ARMOUR PIERCING 1, TWO-HANDED. LIMIT: 1. Death Jester Only.' },
  { id: 'shuriken_cannon_harlequins', name: 'Shuriken Cannon', type: 'ranged', range: 24, cost: 35, limit: 2, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'HEAVY', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '24", +1 INJURY DICE, HEAVY, ARMOUR PIERCING 1, TWO-HANDED. LIMIT: 2.' },
  // Melee
  ...
  { id: 'power_blade_harlequins', name: 'Power Blade', type: 'melee', cost: 17, isMainHandOnly: true, keywords: ['ARMOUR PIERCING 2', 'MAIN HAND ONLY'], description: 'Melee, ARMOUR PIERCING 2, MAIN HAND ONLY. Elite Only.' },
  ...
  // Thrown
  { id: 'hallucinogen_grenades', name: 'Hallucinogen Grenades', type: 'ranged', range: 8, cost: 20, limit: 2, keywords: ['ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'], description: '8", ASSAULT, BLAST 3", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, THROWN. Hit targets must move D3" on a hit. LIMIT: 2.' },
  { id: 'haywire_grenades_harlequins', name: 'Haywire Grenades', type: 'ranged', range: 8, cost: 17, limit: 2, keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', 'ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'STUN', 'THROWN'], description: '8", IGNORE ARMOUR, -1 INJURY DICE non-ARTIFICIAL/VEHICLE, ASSAULT, BLAST 3", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, STUN, THROWN. LIMIT: 2.' },
  { id: 'prismatic_grenades', name: 'Prismatic Grenades', type: 'ranged', range: 8, cost: 12, keywords: ['BLAST 2"', 'FUMBLE', 'THROWN'], description: '8", BLAST 2", FUMBLE, THROWN. +1 DICE to Hit enemies hit by this attack during the same Activation.' },
  { id: 'star_bolas', name: 'Star Bolas', type: 'ranged', range: 12, cost: 25, keywords: ['ASSAULT', 'BLAST 3"', 'FIRE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'], description: '12", ASSAULT, BLAST 3", FIRE, IGNORE COVER, IGNORE LONG RANGE, THROWN. Skyweaver Only.' },
  { id: 'tanglefoot_grenades', name: 'Tanglefoot Grenades', type: 'ranged', range: 8, cost: 10, limit: 3, keywords: ['+1 INJURY DICE', 'ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'IGNORE ARMOUR', 'NONLETHAL', 'STUN', 'THROWN'], description: '8", +1 INJURY DICE, ASSAULT, BLAST 3", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, IGNORE ARMOUR, NONLETHAL, STUN MARKERS, STUN, THROWN. LIMIT: 3.' },
  // Campaign Shop Weapons
  { id: 'crescendo_harlequins', name: 'Crescendo', type: 'ranged', range: 12, cost: 2, costCurrency: 'glory', limit: 1, keywords: ['ASSAULT', 'PISTOL', 'ARMOUR PIERCING 1', 'IGNORE ARMOUR on Critical Hit'], description: '12", ASSAULT, PISTOL, ARMOUR PIERCING 1, IGNORE ARMOUR on Critical Hit. 2 Glory. LIMIT: 1.' },
  { id: 'cegorach_rose_harlequins', name: "Cegorach's Rose", type: 'melee', cost: 4, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+1 INJURY DICE', 'ARMOUR PIERCING 2', 'MAIN HAND ONLY'], description: "Melee, +1 INJURY DICE, ARMOUR PIERCING 2, MAIN HAND ONLY. 4 Glory. LIMIT: 1." },
  { id: 'serpent_tail_harlequins', name: "Serpent's Tail", type: 'melee', cost: 3, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+1 INJURY DICE', 'VICIOUS 10', 'CRITICAL', 'MAIN HAND ONLY'], description: "Melee, +1 INJURY DICE, VICIOUS 10, CRITICAL, MAIN HAND ONLY. 3 Glory. LIMIT: 1." },
  { id: 'storied_sword_harlequins', name: 'Storied Sword', type: 'melee', cost: 5, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+2 DICE', 'CRITICAL', 'ARMOUR PIERCING 1', 'MAIN HAND ONLY'], description: "Melee, +2 DICE, CRITICAL, ARMOUR PIERCING 1, MAIN HAND ONLY. Melee attacks against the wielder have -1 DICE. 5 Glory. LIMIT: 1. Elite Only.", restrictedTo: ['ELITE'] },
];
...
export const tyranidsWeapons: Weapon[] = [
  ...
  // Ranged
  { id: 'devourer', name: 'Devourer', type: 'ranged', range: 18, cost: 5, handedness: 'two-handed', keywords: ['TWO-HANDED'], description: '18", TWO-HANDED.' },
  { id: 'fleshborer', name: 'Fleshborer', type: 'ranged', range: 18, cost: 10, handedness: 'two-handed', keywords: ['ASSAULT', 'TWO-HANDED'], description: '18", ASSAULT, TWO-HANDED.' },
  { id: 'shardlauncher', name: 'Shardlauncher', type: 'ranged', range: 18, cost: 15, handedness: 'two-handed', keywords: ['IGNORE COVER', 'BLAST 2"', 'SHRAPNEL', 'TWO-HANDED'], description: '18", IGNORE COVER, BLAST 2", SHRAPNEL, TWO-HANDED.' },
  { id: 'spike_rifle', name: 'Spike Rifle', type: 'ranged', range: 24, cost: 12, handedness: 'two-handed', keywords: ['ARMOUR PIERCING 1', 'TWO-HANDED'], description: '24", ARMOUR PIERCING 1, TWO-HANDED.' },
  { id: 'spinefists', name: 'Spinefists', type: 'ranged', range: 12, cost: 12, handedness: 'two-handed', keywords: ['+1 DICE', 'ASSAULT', 'TWO-HANDED'], description: '12", +1 DICE, ASSAULT, TWO-HANDED.' },
  { id: 'strangleweb', name: 'Strangleweb', type: 'ranged', range: 12, cost: 20, limit: 2, handedness: 'two-handed', keywords: ['FLAMETHROWER', 'STUN', 'TWO-HANDED'], description: '12", FLAMETHROWER, STUN, TWO-HANDED. LIMIT: 2.' },
  // Heavy Ranged
  { id: 'barbed_strangler', name: 'Barbed Strangler', type: 'ranged', range: 24, cost: 20, limit: 2, handedness: 'two-handed', keywords: ['BLAST 2"', 'HEAVY', 'STUN', 'TWO-HANDED'], description: '24", BLAST 2", HEAVY, STUN, TWO-HANDED. LIMIT: 2.' },
  { id: 'barblauncher', name: 'Barblauncher', type: 'ranged', range: 24, cost: 15, limit: 2, handedness: 'two-handed', keywords: ['IGNORE COVER', 'BLAST 2"', 'HEAVY', 'SHRAPNEL', 'TWO-HANDED'], description: '24", IGNORE COVER, BLAST 2", HEAVY, SHRAPNEL, TWO-HANDED. LIMIT: 2.' },
  { id: 'deathspitter', name: 'Deathspitter', type: 'ranged', range: 24, cost: 10, handedness: 'two-handed', keywords: ['GAS', 'HEAVY', 'TWO-HANDED'], description: '24", GAS, HEAVY, TWO-HANDED.' },
  { id: 'heavy_devourer', name: 'Heavy Devourer', type: 'ranged', range: 18, cost: 20, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'HEAVY', 'TWO-HANDED'], description: '18", +1 INJURY DICE, HEAVY, TWO-HANDED.' },
  { id: 'heavy_venom_cannon', name: 'Heavy Venom Cannon', type: 'ranged', range: 36, cost: 45, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'BLAST 2"', 'HEAVY', 'ARMOUR PIERCING 2', 'TWO-HANDED'], description: '36", +1 INJURY DICE, BLAST 2", HEAVY, ARMOUR PIERCING 2, TWO-HANDED. LIMIT: 1.' },
  { id: 'impaler_cannon', name: 'Impaler Cannon', type: 'ranged', range: 36, cost: 25, handedness: 'two-handed', keywords: ['IGNORE COVER', 'HEAVY', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '36", IGNORE COVER, HEAVY, ARMOUR PIERCING 1, TWO-HANDED.' },
  { id: 'miasma_cannon', name: 'Miasma Cannon', type: 'ranged', range: 36, cost: 180, limit: 1, handedness: 'two-handed', keywords: ['IGNORE ARMOUR', 'BLAST 3"', 'GAS', 'TWO-HANDED'], description: '36", IGNORE ARMOUR, BLAST 3", GAS, TWO-HANDED. 6 Glory. LIMIT: 1.' },
  { id: 'shockcannon', name: 'Shockcannon', type: 'ranged', range: 24, cost: 60, limit: 1, keywords: ['IGNORE ARMOUR', 'HEAVY', 'STUN'], description: '24", IGNORE ARMOUR, HEAVY, STUN. 2 Glory. LIMIT: 1.' },
  { id: 'strangethorn_cannon', name: 'Strangethorn Cannon', type: 'ranged', range: 36, cost: 40, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'BLAST 2"', 'HEAVY', 'STUN', 'TWO-HANDED'], description: '36", +1 INJURY DICE, BLAST 2", HEAVY, STUN, TWO-HANDED. LIMIT: 1.' },
  { id: 'toxinjector_harpoon', name: 'Toxinjector Harpoon', type: 'ranged', range: 10, cost: 90, limit: 1, handedness: 'two-handed', keywords: ['IGNORE COVER', 'IGNORE LONG RANGE', 'SHRAPNEL', 'TWO-HANDED'], description: '10", TWO-HANDED, IGNORE COVER, IGNORE LONG RANGE, SHRAPNEL. 3 Glory. LIMIT: 1. Elite Only. Causes no injury but BLOOD MARKER; pulls non-LARGE target to wielder.', restrictedTo: ['ELITE'] },
  { id: 'venom_cannon', name: 'Venom Cannon', type: 'ranged', range: 24, cost: 25, limit: 1, handedness: 'two-handed', keywords: ['BLAST 2"', 'HEAVY', 'ARMOUR PIERCING 2', 'TWO-HANDED'], description: '24", BLAST 2", HEAVY, ARMOUR PIERCING 2, TWO-HANDED. LIMIT: 1.' },
  // Thrown
  { id: 'blinding_venom', name: 'Blinding Venom', type: 'ranged', range: 1, cost: 5, keywords: ['GAS', 'THROWN'], description: 'Melee, GAS, THROWN. Gargoyle Only. Causes no injury but BLOOD MARKER; target cannot attack models that Retreat from it until end of Turn.' },
  { id: 'electroshock_grubs', name: 'Electroshock Grubs', type: 'ranged', range: 6, cost: 10, limit: 2, keywords: ['ASSAULT', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'STUN', 'THROWN'], description: '6", ASSAULT, FUMBLE, IGNORE COVER, IGNORE LONG RANGE, STUN, THROWN. LIMIT: 2.' },
  { id: 'desiccator_larvae', name: 'Desiccator Larvae', type: 'ranged', range: 6, cost: 15, limit: 2, keywords: ['ASSAULT', 'IGNORE ARMOUR', 'FUMBLE', 'GAS', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'], description: '6", ASSAULT, IGNORE ARMOUR, FUMBLE, GAS, IGNORE COVER, IGNORE LONG RANGE, THROWN. LIMIT: 2.' },
  { id: 'shreddershard_beetles', name: 'Shreddershard Beetles', type: 'ranged', range: 6, cost: 15, limit: 2, keywords: ['ASSAULT', 'BLAST 2"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'SHRAPNEL', 'THROWN'], description: '6", ASSAULT, BLAST 2", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, SHRAPNEL, THROWN. LIMIT: 2.' },
  { id: 'toxic_glands', name: 'Toxic Glands', type: 'ranged', range: 6, cost: 12, limit: 1, keywords: ['ASSAULT', 'FUMBLE', 'IGNORE LONG RANGE', 'INFECTION MARKERS', 'THROWN'], description: '6", ASSAULT, FUMBLE, IGNORE LONG RANGE, INFECTION MARKERS, THROWN. LIMIT: 1. Ravener Only.' },
  { id: 'venom_blast', name: 'Venom Blast', type: 'ranged', range: 8, cost: 30, limit: 1, keywords: ['FLAMETHROWER', 'IGNORE ARMOUR', 'GAS', 'THROWN'], description: '8", FLAMETHROWER, IGNORE ARMOUR, GAS, THROWN. LIMIT: 1. Ravener Only.' },
  // Tail Weapons
  ...
  // Campaign Shop Weapons
  { id: 'shardgullet_ty', name: 'Shardgullet', type: 'ranged', range: 36, cost: 4, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'ASSAULT', 'HEAVY', 'TWO-HANDED'], description: '36", +1 INJURY DICE, IGNORE ARMOUR, ASSAULT, HEAVY, TWO-HANDED. 4 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'reaper_of_obliterax', name: 'Reaper of Obliterax', type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['VICIOUS 11', '+1 INJURY DICE', 'CRITICAL', 'HEAVY', 'MAIN HAND ONLY'], description: 'Melee, VICIOUS 11, +1 INJURY DICE, Injury roll cannot benefit from any -DICE, CRITICAL, HEAVY, MAIN HAND ONLY. 2 Glory. LIMIT: 1.' },
];
...
export const tauEmpireWeapons: Weapon[] = [
  // Ranged
  { id: 'dart_bow_tau', name: 'Dart Bow', type: 'ranged', range: 24, cost: 12, handedness: 'two-handed', keywords: ['CRITICAL', 'TWO-HANDED'], description: '24", CRITICAL, TWO-HANDED. Attacks can use Melee Skill. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'dvorgite_skinner', name: 'Dvorgite Skinner', type: 'ranged', range: 8, cost: 30, limit: 1, handedness: 'two-handed', keywords: ['FLAMETHROWER', 'IGNORE ARMOUR', 'GAS', 'TWO-HANDED'], description: '8", FLAMETHROWER, IGNORE ARMOUR, GAS, TWO-HANDED. LIMIT: 1. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'ion_rifle_tau', name: 'Ion Rifle', type: 'ranged', range: 30, cost: 25, limit: 1, keywords: ['+1 INJURY DICE'], description: '30", +1 INJURY DICE. Standard/Overload profiles. LIMIT: 1.' },
  { id: 'kroot_carbine', name: 'Kroot Carbine', type: 'ranged', range: 18, cost: 10, handedness: 'two-handed', keywords: ['ASSAULT', 'TWO-HANDED'], description: '18", ASSAULT, TWO-HANDED. Bayonet Lug. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'kroot_rifle', name: 'Kroot Rifle', type: 'ranged', range: 24, cost: 5, handedness: 'two-handed', keywords: ['TWO-HANDED'], description: '24", TWO-HANDED. Bayonet Lug. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'kroot_shaper_rifle', name: 'Kroot Shaper Rifle', type: 'ranged', range: 24, cost: 10, handedness: 'two-handed', keywords: ['ARMOUR PIERCING 1', 'TWO-HANDED'], description: '24", ARMOUR PIERCING 1, TWO-HANDED. Bayonet Lug. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'kroot_scattergun', name: 'Kroot Scattergun', type: 'ranged', range: 12, cost: 10, handedness: 'two-handed', keywords: ['+1 DICE', 'SHOTGUN', 'TWO-HANDED'], description: '12", +1 DICE, SHOTGUN, TWO-HANDED. Bayonet Lug. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'pulse_blaster', name: 'Pulse Blaster', type: 'ranged', range: 10, cost: 15, limit: 2, handedness: 'two-handed', keywords: ['ASSAULT', 'TWO-HANDED'], description: '10", ASSAULT, TWO-HANDED. Can take two Shoot Actions per Activation. LIMIT: 2.' },
  { id: 'pulse_carbine', name: 'Pulse Carbine', type: 'ranged', range: 20, cost: 12, handedness: 'two-handed', keywords: ['ASSAULT', 'TWO-HANDED'], description: '20", ASSAULT, TWO-HANDED.' },
  { id: 'pulse_rifle', name: 'Pulse Rifle', type: 'ranged', range: 30, cost: 10, handedness: 'two-handed', keywords: ['TWO-HANDED'], description: '30", TWO-HANDED.' },
  { id: 'rail_rifle_tau', name: 'Rail Rifle', type: 'ranged', range: 30, cost: 40, limit: 1, handedness: 'two-handed', keywords: ['IGNORE ARMOUR', 'CRITICAL', 'TWO-HANDED'], description: '30", IGNORE ARMOUR, CRITICAL, TWO-HANDED. LIMIT: 1.' },
  { id: 'semi_automatic_gl', name: 'Semi-Automatic GL', type: 'ranged', range: 18, cost: 40, limit: 1, handedness: 'two-handed', keywords: ['IGNORE COVER', 'BLAST 2"', 'TWO-HANDED'], description: '18", IGNORE COVER, BLAST 2", TWO-HANDED. EMP: IGNORE ARMOUR, -1 INJURY DICE, BLAST 3", STUN. Fusion: ARMOUR PIERCING 2. LIMIT: 1.' },
  { id: 'tanglebomb_launcher', name: 'Tanglebomb Launcher', type: 'ranged', range: 24, cost: 10, limit: 2, handedness: 'two-handed', keywords: ['IGNORE ARMOUR', '+2 INJURY DICE', 'STUN MARKERS', 'NONLETHAL', 'BLAST 2"', 'STUN', 'TWO-HANDED'], description: '24", IGNORE ARMOUR, +2 INJURY DICE, STUN MARKERS, NONLETHAL, BLAST 2", STUN, TWO-HANDED. LIMIT: 2. Kroot Only.', restrictedTo: ['KROOT'] },
  // Pistols
  { id: 'kroot_pistol', name: 'Kroot Pistol', type: 'ranged', range: 12, cost: 5, keywords: ['PISTOL'], description: '12", PISTOL. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'pulse_pistol', name: 'Pulse Pistol', type: 'ranged', range: 16, cost: 10, keywords: ['PISTOL'], description: '16", PISTOL.' },
  { id: 'twin_pulse_pistols', name: 'Twin Pulse Pistols', type: 'ranged', range: 16, cost: 15, limit: 2, handedness: 'two-handed', keywords: ['+1 DICE', 'CUMBERSOME', 'TWO-HANDED', 'PISTOL'], description: '16", +1 DICE, CUMBERSOME, TWO-HANDED, PISTOL. LIMIT: 2.' },
  // Heavy Ranged
  { id: 'londaxi_tribalest', name: 'Londaxi Tribalest', type: 'ranged', range: 18, cost: 35, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'HEAVY', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '18", +1 INJURY DICE, HEAVY, ARMOUR PIERCING 1, TWO-HANDED. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'repeater_cannon_tau', name: 'Repeater Cannon', type: 'ranged', range: 36, cost: 45, limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', 'ASSAULT', 'HEAVY', 'TWO-HANDED'], description: '36", AUTOMATIC 2, ASSAULT, HEAVY, TWO-HANDED. LIMIT: 1. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'tanglecannon', name: 'Tanglecannon', type: 'ranged', range: 36, cost: 15, limit: 1, handedness: 'two-handed', keywords: ['IGNORE ARMOUR', '+2 INJURY DICE', 'STUN MARKERS', 'NONLETHAL', 'BLAST 3"', 'HEAVY', 'STUN', 'TWO-HANDED'], description: '36", IGNORE ARMOUR, +2 INJURY DICE, STUN MARKERS, NONLETHAL, BLAST 3", HEAVY, STUN, TWO-HANDED. LIMIT: 1. Kroot Only.', restrictedTo: ['KROOT'] },
  // Battlesuit Weapons
  ...
  { id: 'burst_cannon_tau', name: 'Burst Cannon', type: 'ranged', range: 18, cost: 15, keywords: ['+1 DICE'], description: '18", +1 DICE. Recon Drone or Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'cyclic_ion_blaster', name: 'Cyclic Ion Blaster', type: 'ranged', range: 18, cost: 3, costCurrency: 'glory', handedness: 'two-handed', keywords: ['AUTOMATIC 2', '+1 INJURY DICE'], description: '18", AUTOMATIC 2, +1 INJURY DICE. 3 Glory. Standard/Overload profiles. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'fragmentation_projector', name: 'Fragmentation Projector', type: 'ranged', range: 24, cost: 35, keywords: ['IGNORE COVER', 'BLAST 3"', 'SHRAPNEL'], description: '24", IGNORE COVER, BLAST 3", SHRAPNEL. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'fusion_blaster_tau', name: 'Fusion Blaster', type: 'ranged', range: 12, cost: 40, limit: 2, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'TWO-HANDED'], description: '12", +1 INJURY DICE, IGNORE ARMOUR, TWO-HANDED. LIMIT: 2. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'he_fusion_blaster', name: 'HE Fusion Blaster', type: 'ranged', range: 18, cost: 5, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+2 INJURY DICE', 'IGNORE ARMOUR', 'TWO-HANDED'], description: '18", +2 INJURY DICE, IGNORE ARMOUR, TWO-HANDED. 5 Glory. LIMIT: 1. Elite Battlesuit Only.', restrictedTo: ['ELITE', 'VEHICLE'] },
  { id: 'hi_plasma_rifle', name: 'HI Plasma Rifle', type: 'ranged', range: 18, cost: 2, costCurrency: 'glory', limit: 1, keywords: ['+1 INJURY MODIFIER', 'ARMOUR PIERCING 1'], description: '18", +1 INJURY MODIFIER, ARMOUR PIERCING 1. 2 Glory. LIMIT: 1. Elite Battlesuit Only.', restrictedTo: ['ELITE', 'VEHICLE'] },
  { id: 'ho_burst_cannon', name: 'HO Burst Cannon', type: 'ranged', range: 18, cost: 3, costCurrency: 'glory', limit: 1, keywords: ['AUTOMATIC 2', '+1 DICE'], description: '18", AUTOMATIC 2, +1 DICE. 3 Glory. LIMIT: 1. Elite Battlesuit Only.', restrictedTo: ['ELITE', 'VEHICLE'] },
  { id: 'missile_pod_tau', name: 'Missile Pod', type: 'ranged', range: 30, cost: 20, keywords: ['IGNORE COVER'], description: '30", IGNORE COVER. Missile Drone or Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'plasma_rifle_tau', name: 'Plasma Rifle', type: 'ranged', range: 18, cost: 35, keywords: ['+1 INJURY MODIFIER', 'ARMOUR PIERCING 1'], description: '18", +1 INJURY MODIFIER, ARMOUR PIERCING 1. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'smart_missile_system', name: 'Smart Missile System', type: 'ranged', range: 30, cost: 25, keywords: ['IGNORE COVER', 'IGNORE LONG RANGE'], description: '30", IGNORE COVER, IGNORE LONG RANGE. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'tau_flamer', name: "T'au Flamer", type: 'ranged', range: 8, cost: 30, limit: 2, keywords: ['FLAMETHROWER', 'IGNORE ARMOUR', '-1 INJURY DICE', 'FIRE'], description: '8", FLAMETHROWER, IGNORE ARMOUR, -1 INJURY DICE, FIRE. LIMIT: 2. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'twin_burst_cannon', name: 'Twin Burst Cannon', type: 'ranged', range: 18, cost: 2, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '+1 DICE', 'TWO-HANDED'], description: '18", AUTOMATIC 2, +1 DICE, TWO-HANDED. 2 Glory. LIMIT: 1. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  // Heavy Battlesuit Weapons
  { id: 'heavy_burst_cannon', name: 'Heavy Burst Cannon', type: 'ranged', range: 36, cost: 50, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '+1 INJURY DICE', 'HEAVY', 'TWO-HANDED'], description: '36", AUTOMATIC 2, +1 INJURY DICE, HEAVY, TWO-HANDED. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'heavy_rail_rifle', name: 'Heavy Rail Rifle', type: 'ranged', range: 48, cost: 3, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'RELOAD', 'CRITICAL', 'HEAVY', 'TWO-HANDED'], description: '48", +1 INJURY DICE, IGNORE ARMOUR, RELOAD, CRITICAL, HEAVY, TWO-HANDED. 3 Glory. LIMIT: 1. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'high_yield_missile_pods', name: 'High-Yield Missile Pods', type: 'ranged', range: 30, cost: 40, handedness: 'two-handed', keywords: ['AUTOMATIC 2', 'IGNORE COVER', 'HEAVY', 'TWO-HANDED'], description: '30", AUTOMATIC 2, IGNORE COVER, HEAVY, TWO-HANDED. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'seeker_missile', name: 'Seeker Missile', type: 'ranged', range: 48, cost: 35, handedness: 'two-handed', keywords: ['DEADLY', 'IGNORE COVER', 'IGNORE LONG RANGE', 'CONSUMABLE', 'HEAVY', 'TWO-HANDED'], description: '48", DEADLY, IGNORE COVER, IGNORE LONG RANGE, CONSUMABLE, HEAVY, TWO-HANDED. Can only be used once per battle. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'twin_plasma_rifle_tau', name: 'Twin Plasma Rifle', type: 'ranged', range: 18, cost: 35, handedness: 'two-handed', keywords: ['+1 DICE', '+1 INJURY MODIFIER', 'HEAVY', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '18", +1 DICE, +1 INJURY MODIFIER, HEAVY, ARMOUR PIERCING 1, TWO-HANDED. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  { id: 'twin_smart_missile_system', name: 'Twin Smart Missile System', type: 'ranged', range: 30, cost: 35, handedness: 'two-handed', keywords: ['+1 DICE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'HEAVY', 'TWO-HANDED'], description: '30", +1 DICE, IGNORE COVER, IGNORE LONG RANGE, HEAVY, TWO-HANDED. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
  // Melee
  ...
  // Thrown
  { id: 'blast_javelin_tau', name: 'Blast Javelin', type: 'ranged', range: 18, cost: 15, limit: 1, keywords: ['ASSAULT', '+1 INJURY DICE', 'IGNORE ARMOUR', 'PISTOL', 'THROWN', 'CONSUMABLE'], description: '18", ASSAULT, +1 INJURY DICE, IGNORE ARMOUR, PISTOL, THROWN, CONSUMABLE. LIMIT: 1. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'emp_grenades_tau', name: 'EMP Grenades', type: 'ranged', range: 8, cost: 17, limit: 2, keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', 'ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'STUN', 'THROWN'], description: '8", IGNORE ARMOUR, -1 INJURY DICE non-ARTIFICIAL/VEHICLE, ASSAULT, BLAST 3", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, STUN, THROWN. LIMIT: 2.' },
  { id: 'hunting_javelins', name: 'Hunting Javelins', type: 'ranged', range: 18, cost: 15, keywords: ['ASSAULT', 'PISTOL', 'THROWN'], description: '18", ASSAULT, PISTOL, THROWN. +1 INJURY DICE in melee if Charged this Activation. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'photon_grenades', name: 'Photon Grenades', type: 'ranged', range: 8, cost: 10, keywords: ['ASSAULT', 'BLAST 3"', 'IGNORE COVER', 'IGNORE LONG RANGE', 'STUN', 'THROWN'], description: '8", ASSAULT, BLAST 3", IGNORE COVER, IGNORE LONG RANGE, STUN, THROWN. Causes no injury but STUN MARKER. Target cannot attack models that Retreat until end of Turn.' },
  { id: 'tri_blades_tau', name: 'Tri-Blades', type: 'ranged', range: 12, cost: 7, keywords: ['IGNORE LONG RANGE', 'ASSAULT', 'THROWN'], description: '12", IGNORE LONG RANGE, ASSAULT, THROWN. Kroot Only.', restrictedTo: ['KROOT'] },
  // Vespid Weapons
  { id: 'neutron_blaster_vespid', name: 'Neutron Blaster', type: 'ranged', range: 18, cost: 0, handedness: 'two-handed', keywords: ['ARMOUR PIERCING 1', 'ASSAULT', 'CRITICAL', 'TWO-HANDED'], description: '18", ARMOUR PIERCING 1 if wielder moved at least 5" during this Activation, ASSAULT, CRITICAL, TWO-HANDED.' },
  { id: 'stingwing_claws_vespid', name: 'Stingwing Claws', type: 'melee', cost: 0, handedness: 'two-handed', keywords: ['ARMOUR PIERCING 1', 'TWO-HANDED'], description: 'Melee, ARMOUR PIERCING 1, TWO-HANDED.' },
  // Campaign Shop Weapons
  { id: 'ka_chak_tarr', name: "Ka'chak'tarr", type: 'ranged', range: 24, cost: 5, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', 'IGNORE COVER', 'ASSAULT', 'ARMOUR PIERCING 1', 'TWO-HANDED'], description: '24", AUTOMATIC 2, IGNORE COVER, ASSAULT, ARMOUR PIERCING 1, TWO-HANDED. Enemies cannot change the target of attacks made with this weapon. 5 Glory. LIMIT: 1. Kroot Only.', restrictedTo: ['KROOT'] },
  { id: 'kindled_blade_tau', name: 'Kindled Blade', type: 'melee', cost: 4, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'CUMBERSOME', 'TWO-HANDED'], description: 'Melee, +1 INJURY DICE, CUMBERSOME, TWO-HANDED. Friendly non-ARTIFICIAL, non-VEHICLE, non-KROOT T\'au models within 9" of the bearer have +1 DICE to Hit with all attacks. 4 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'krep_chak', name: "Krep'chak", type: 'melee', cost: 4, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['CLEAVE 2', 'CRITICAL', 'MAIN HAND ONLY'], description: "Melee, CLEAVE 2, CRITICAL, MAIN HAND ONLY. The first time the equipped model takes an enemy Out of Action in melee during each battle, this weapon gains +1 INJURY DICE and ARMOUR PIERCING 1 until the end of the battle. 4 Glory. LIMIT: 1. Kroot Only.", restrictedTo: ['KROOT'] },
  { id: 'onager_gauntlet_tau', name: 'Onager Gauntlet', type: 'melee', cost: 6, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['DEADLY', 'HEAVY', 'RELOAD', 'TWO-HANDED'], description: 'Melee, DEADLY, HEAVY, RELOAD, TWO-HANDED. 6 Glory. LIMIT: 1. Battlesuit Only.', restrictedTo: ['VEHICLE'] },
];
...
export const slanniWeapons: Weapon[] = [
  // Ranged
  { id: 'beam_rifle', name: 'Beam Rifle', type: 'ranged', range: 24, cost: 25, handedness: 'two-handed', keywords: ['+1 INJURY MODIFIER', 'TWO-HANDED'], description: '24", +1 INJURY MODIFIER, TWO-HANDED.' },
  { id: 'charge_rifle', name: 'Charge Rifle', type: 'ranged', range: 24, cost: 10, handedness: 'two-handed', keywords: ['VICIOUS 11', 'TWO-HANDED'], description: '24", VICIOUS 11, TWO-HANDED.' },
  { id: 'charge_shotgun', name: 'Charge Shotgun', type: 'ranged', range: 12, cost: 12, handedness: 'two-handed', keywords: ['SHOTGUN', 'VICIOUS 11', 'TWO-HANDED'], description: '12", SHOTGUN, VICIOUS 11, TWO-HANDED, Shield Combo.' },
  { id: 'gravity_rifle', name: 'Gravity Rifle', type: 'ranged', range: 18, cost: 30, limit: 2, handedness: 'two-handed', keywords: ['IGNORE ARMOUR', 'STUN', 'TWO-HANDED'], description: '18", IGNORE ARMOUR, STUN, TWO-HANDED. LIMIT: 2.' },
  { id: 'beam_sniper_rifle', name: 'Beam Sniper Rifle', type: 'ranged', range: 48, cost: 40, limit: 1, handedness: 'two-handed', keywords: ['+1 DICE', '+1 INJURY MODIFIER', 'CRITICAL', 'RISKY', 'TWO-HANDED'], description: '48", +1 DICE, +1 INJURY MODIFIER, CRITICAL, RISKY, TWO-HANDED. LIMIT: 1.' },
  { id: 'net_launcher', name: 'Net Launcher', type: 'ranged', range: 18, cost: 10, limit: 3, handedness: 'two-handed', keywords: ['+2 INJURY DICE', 'BLAST 2"', 'IGNORE ARMOUR', 'NONLETHAL', 'STUN MARKERS', 'STUN', 'TWO-HANDED'], description: '18", +2 INJURY DICE, BLAST 2", IGNORE ARMOUR, NONLETHAL, STUN MARKERS, STUN, TWO-HANDED. LIMIT: 3.' },
  { id: 'heat_rifle', name: 'Heat Rifle', type: 'ranged', range: 24, cost: 15, limit: 2, keywords: ['CRITICAL', 'FIRE'], description: '24", CRITICAL, FIRE. LIMIT: 2.' },
  { id: 'scatter_rifle', name: 'Scatter Rifle', type: 'ranged', range: 24, cost: 40, limit: 1, handedness: 'two-handed', keywords: ['ASSAULT', 'AUTOMATIC 2', 'TWO-HANDED'], description: '24", ASSAULT, AUTOMATIC 2, TWO-HANDED. LIMIT: 1.' },
  { id: 'slanni_flamer', name: 'Slanni Flamer', type: 'ranged', range: 12, cost: 35, limit: 2, handedness: 'two-handed', keywords: ['FLAMETHROWER', 'IGNORE ARMOUR', '-1 INJURY DICE', 'FIRE', 'TWO-HANDED'], description: '12", FLAMETHROWER, IGNORE ARMOUR, -1 INJURY DICE, FIRE, TWO-HANDED. LIMIT: 2.' },
  // Pistols
  { id: 'charge_pistol', name: 'Charge Pistol', type: 'ranged', range: 12, cost: 7, keywords: ['VICIOUS 11', 'PISTOL'], description: '12", VICIOUS 11, PISTOL.' },
  { id: 'gravity_projector', name: 'Gravity Projector', type: 'ranged', range: 12, cost: 90, limit: 1, keywords: ['IGNORE ARMOUR', 'STUN', 'PISTOL'], description: '12", IGNORE ARMOUR, STUN, PISTOL. 3 Glory. LIMIT: 1.' },
  { id: 'beam_pistol', name: 'Beam Pistol', type: 'ranged', range: 12, cost: 25, limit: 2, keywords: ['+1 INJURY MODIFIER', 'PISTOL'], description: '12", +1 INJURY MODIFIER, PISTOL. LIMIT: 2.' },
  { id: 'heat_pistol', name: 'Heat Pistol', type: 'ranged', range: 12, cost: 20, limit: 1, keywords: ['CRITICAL', 'FIRE', 'PISTOL'], description: '12", CRITICAL, FIRE, PISTOL. LIMIT: 1.' },
  { id: 'net_pistol', name: 'Net Pistol', type: 'ranged', range: 12, cost: 5, limit: 2, keywords: ['+2 INJURY DICE', 'IGNORE ARMOUR', 'NONLETHAL', 'PISTOL', 'STUN MARKERS', 'STUN'], description: '12", +2 INJURY DICE, IGNORE ARMOUR, NONLETHAL, PISTOL, STUN MARKERS, STUN. LIMIT: 2.' },
  { id: 'neuro_disruptor_slanni', name: 'Neuro Disruptor', type: 'ranged', range: 12, cost: 30, limit: 2, keywords: ['-1 INJURY DICE', 'ASSAULT', 'IGNORE ARMOUR', 'PISTOL'], description: '12", -1 INJURY DICE, ASSAULT, IGNORE ARMOUR, PISTOL. LIMIT: 2. Elite Psyker Only.' },
  // Heavy Ranged
  { id: 'distortion_cannon_slanni', name: 'Distortion Cannon', type: 'ranged', range: 10, cost: 120, limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '-1 INJURY DICE', '+1 INJURY DICE', 'FLAMETHROWER', 'IGNORE ARMOUR', 'HEAVY', 'PSYCHIC', 'TWO-HANDED'], description: '10", AUTOMATIC 2, -1 INJURY DICE, FLAMETHROWER, +1 INJURY DICE, IGNORE ARMOUR, HEAVY, PSYCHIC, TWO-HANDED. 4 Glory. LIMIT: 1.' },
  { id: 'gravity_cannon', name: 'Gravity Cannon', type: 'ranged', range: 36, cost: 50, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'IGNORE ARMOUR', 'HEAVY', 'STUN', 'TWO-HANDED'], description: '36", +1 INJURY DICE, IGNORE ARMOUR, HEAVY, STUN, TWO-HANDED. LIMIT: 1.' },
  { id: 'heavy_beamer', name: 'Heavy Beamer', type: 'ranged', range: 48, cost: 40, limit: 2, handedness: 'two-handed', keywords: ['+1 DICE', '+1 INJURY DICE', 'CRITICAL', 'HEAVY', 'RISKY', 'TWO-HANDED'], description: '48", +1 DICE, +1 INJURY DICE, CRITICAL, HEAVY, RISKY, TWO-HANDED. LIMIT: 2.' },
  { id: 'scatter_cannon_slanni', name: 'Scatter Cannon', type: 'ranged', range: 36, cost: 50, limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 3', 'HEAVY', 'RELOAD', 'TWO-HANDED'], description: '36", AUTOMATIC 3, HEAVY, RELOAD, TWO-HANDED. LIMIT: 1.' },
  // Melee
  ...
  // Heavy Melee
  { id: 'celestite_warmace', name: 'Celestite Warmace', type: 'melee', cost: 25, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY MODIFIER', 'HEAVY', 'IGNORE ARMOUR on Critical Hit', 'TWO-HANDED'], description: 'Melee, +1 INJURY MODIFIER, HEAVY, IGNORE ARMOUR on Critical Hit, TWO-HANDED. LIMIT: 1.' },
  ...
  // Thrown
  { id: 'gravity_bombs', name: 'Gravity Bombs', type: 'ranged', range: 8, cost: 25, limit: 1, keywords: ['+1 INJURY DICE', 'BLAST 2"', 'IGNORE ARMOUR', 'ASSAULT', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'], description: '8", +1 INJURY DICE, BLAST 2", IGNORE ARMOUR, ASSAULT, FUMBLE, IGNORE COVER, IGNORE LONG RANGE, THROWN. LIMIT: 1.' },
  { id: 'net_bombs', name: 'Net Bombs', type: 'ranged', range: 8, cost: 15, keywords: ['+1 INJURY DICE', 'ASSAULT', 'BLAST 2"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'IGNORE ARMOUR', 'NONLETHAL', 'STUN MARKERS', 'STUN', 'THROWN'], description: '8", +1 INJURY DICE, ASSAULT, BLAST 2", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, IGNORE ARMOUR, NONLETHAL, STUN MARKERS, STUN, THROWN.' },
  { id: 'hypertoxin_grenades', name: 'Hypertoxin Grenades', type: 'ranged', range: 8, cost: 25, limit: 2, keywords: ['IGNORE ARMOUR', 'ASSAULT', 'BLAST 3"', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'GAS', 'THROWN'], description: '8", IGNORE ARMOUR, ASSAULT, BLAST 3", FUMBLE, IGNORE COVER, IGNORE LONG RANGE, GAS, THROWN. LIMIT: 2.' },
  { id: 'plasma_grenades_slanni', name: 'Plasma Grenades', type: 'ranged', range: 8, cost: 20, keywords: ['ASSAULT', 'BLAST 2"', 'FIRE', 'FUMBLE', 'IGNORE COVER', 'IGNORE LONG RANGE', 'THROWN'], description: '8", ASSAULT, BLAST 2", FIRE, FUMBLE, IGNORE COVER, IGNORE LONG RANGE, THROWN.' },
  // Campaign Shop Weapons
  { id: 'blade_of_realities_slanni', name: 'Blade of Realities', type: 'melee', cost: 4, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+1 INJURY DICE vs ELITE/TOUGH', 'IGNORE ARMOUR', 'MAIN HAND ONLY'], description: 'Melee, +1 INJURY DICE against ELITE or TOUGH models, IGNORE ARMOUR, MAIN HAND ONLY. 4 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'spacefolder_stave_slanni', name: "Spacefolder's Stave", type: 'melee', cost: 6, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+1 DICE', '+1 INJURY DICE vs DAEMON/PSYKER', 'PSYCHIC', 'HELD', 'MAIN HAND ONLY'], description: 'Melee, +1 DICE, +1 INJURY DICE against targets with DAEMON or PSYKER Keyword, PSYCHIC, HELD, MAIN HAND ONLY. Before deployment, this model and up to two non-ELITE SLANN models gain DEEP STRIKE for the battle; they must deploy all at once within 3" of each other. 6 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
];
...
export const orksWeapons: Weapon[] = [
  // Ranged
  { id: 'burna', name: 'Burna', type: 'ranged', range: 8, cost: 30, limit: 3, handedness: 'two-handed', keywords: ['FLAMETHROWER', 'IGNORE ARMOUR', '-1 INJURY DICE', 'FIRE', 'TWO-HANDED'], description: '8", FLAMETHROWER, IGNORE ARMOUR, -1 INJURY DICE, FIRE, TWO-HANDED. LIMIT: 3.' },
  { id: 'shoota', name: 'Shoota', type: 'ranged', range: 18, cost: 10, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '-1 DICE', 'TWO-HANDED'], description: '18", AUTOMATIC 2, -1 DICE, TWO-HANDED.' },
  { id: 'speshul_shoota', name: 'Speshul Shoota', type: 'ranged', range: 12, cost: 10, handedness: 'two-handed', keywords: ['ASSAULT', '-1 DICE', 'SHOTGUN', 'TWO-HANDED'], description: '12", ASSAULT, -1 DICE, SHOTGUN, TWO-HANDED.' },
  { id: 'thump_gun', name: 'Thump Gun', type: 'ranged', range: 18, cost: 10, handedness: 'two-handed', keywords: ['BLAST 2"', '-1 DICE', 'SHRAPNEL', 'TWO-HANDED'], description: '18", BLAST 2", -1 DICE, SHRAPNEL, TWO-HANDED.' },
  // Pistols
  { id: 'grot_blasta', name: 'Grot Blasta', type: 'ranged', range: 12, cost: 5, keywords: ['PISTOL'], description: '12", PISTOL. Gretchin Only.' },
  { id: 'kustom_mega_slugga', name: 'Kustom Mega Slugga', type: 'ranged', range: 12, cost: 10, limit: 1, keywords: ['BLAST 2"', 'ARMOUR PIERCING 2', 'DANGEROUS', 'STUN', 'PISTOL'], description: '12", BLAST 2", ARMOUR PIERCING 2, DANGEROUS, STUN, PISTOL. LIMIT: 1. Mek or Big Mek Only.' },
  { id: 'rokkit_pistol', name: 'Rokkit Pistol', type: 'ranged', range: 12, cost: 5, keywords: ['HEAVY', 'RISKY', 'ARMOUR PIERCING 1', 'PISTOL'], description: '12", HEAVY, RISKY, ARMOUR PIERCING 1, PISTOL.' },
  { id: 'shokka_pistol', name: 'Shokka Pistol', type: 'ranged', range: 12, cost: 5, keywords: ['ASSAULT', 'HEAVY', 'PISTOL', 'DANGEROUS (-1 INJURY DICE, NONLETHAL, STUN MARKERS)', 'STUN'], description: '12", ASSAULT, HEAVY, PISTOL, DANGEROUS (-1 INJURY DICE, NONLETHAL, STUN MARKERS), STUN. Mek or Big Mek Only.' },
  { id: 'slugga', name: 'Slugga', type: 'ranged', range: 12, cost: 3, keywords: ['ASSAULT', '-1 DICE', 'PISTOL'], description: '12", ASSAULT, -1 DICE, PISTOL.' },
  { id: 'twin_slugga', name: 'Twin Slugga', type: 'ranged', range: 12, cost: 10, limit: 2, keywords: ['AUTOMATIC 2', 'ASSAULT', 'HEAVY', '-1 DICE', 'PISTOL'], description: '12", AUTOMATIC 2, ASSAULT, HEAVY, -1 DICE, PISTOL. LIMIT: 2. Elite Only.', restrictedTo: ['ELITE'] },
  // Heavy Ranged
  { id: 'big_shoota', name: 'Big Shoota', type: 'ranged', range: 36, cost: 35, handedness: 'two-handed', keywords: ['AUTOMATIC 3', 'HEAVY', 'RELOAD', '-1 DICE', 'TWO-HANDED'], description: '36", AUTOMATIC 3, HEAVY, RELOAD, -1 DICE, TWO-HANDED. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'deffgun', name: 'Deffgun', type: 'ranged', range: 36, cost: 2, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '+1 INJURY DICE', 'HEAVY', '-1 DICE', 'TWO-HANDED'], description: '36", AUTOMATIC 2, +1 INJURY DICE, HEAVY, -1 DICE, TWO-HANDED. 2 Glory. LIMIT: 1.' },
  { id: 'kombi_weapon_orks', name: 'Kombi-Weapon', type: 'ranged', range: 24, cost: 15, limit: 3, keywords: ['AUTOMATIC 2', 'ASSAULT', 'CRITICAL', 'HEAVY', '-1 DICE'], description: '24", AUTOMATIC 2, ASSAULT, CRITICAL, HEAVY, -1 DICE. LIMIT: 3.' },
  { id: 'kustom_mega_blasta', name: 'Kustom Mega-Blasta', type: 'ranged', range: 24, cost: 20, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'HEAVY', 'ARMOUR PIERCING 2', 'DANGEROUS', 'TWO-HANDED'], description: '24", +1 INJURY DICE, HEAVY, ARMOUR PIERCING 2, DANGEROUS, TWO-HANDED. LIMIT: 1. Mek or Big Mek Only.' },
  { id: 'kustom_shoota', name: 'Kustom Shoota', type: 'ranged', range: 18, cost: 20, limit: 2, keywords: ['AUTOMATIC 3', '-1 DICE', 'HEAVY'], description: '18", AUTOMATIC 3, -1 DICE, HEAVY. LIMIT: 2.' },
  { id: 'rokkit_launcha', name: 'Rokkit Launcha', type: 'ranged', range: 24, cost: 20, limit: 3, handedness: 'two-handed', keywords: ['IGNORE COVER', 'BLAST 3"', 'HEAVY', 'RISKY', 'SHRAPNEL', 'TWO-HANDED'], description: '24", IGNORE COVER, BLAST 3", HEAVY, RISKY, SHRAPNEL, TWO-HANDED. LIMIT: 3.' },
  { id: 'shokk_attack_gun', name: 'Shokk Attack Gun', type: 'ranged', range: 48, cost: 60, handedness: 'two-handed', keywords: ['IGNORE COVER', 'IGNORE ARMOUR', 'HEAVY', 'DANGEROUS (STUN MARKERS)', 'STUN', 'TWO-HANDED'], description: '48", IGNORE COVER, IGNORE ARMOUR, HEAVY, DANGEROUS (STUN MARKERS), STUN, TWO-HANDED. 2 Glory. Mek or Big Mek Only.' },
  { id: 'skorcha', name: 'Skorcha', type: 'ranged', range: 10, cost: 55, limit: 1, handedness: 'two-handed', keywords: ['AUTOMATIC 2', '-1 INJURY DICE', 'FLAMETHROWER', 'IGNORE ARMOUR', 'FIRE', 'HEAVY', 'TWO-HANDED'], description: '10", AUTOMATIC 2, -1 INJURY DICE, FLAMETHROWER, IGNORE ARMOUR, FIRE, HEAVY, TWO-HANDED. LIMIT: 1.' },
  { id: 'traktor_blasta', name: 'Traktor Blasta', type: 'ranged', range: 36, cost: 20, limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'HEAVY', 'RISKY', 'TWO-HANDED'], description: '36", +1 INJURY DICE, HEAVY, RISKY, TWO-HANDED. Non-LARGE hit moved D6" toward wielder. LIMIT: 1. Mek or Big Mek Only.' },
  { id: 'twin_dakkagun', name: 'Twin Dakkagun', type: 'ranged', range: 18, cost: 35, handedness: 'two-handed', keywords: ['AUTOMATIC 3', '+1 DICE', '-1 INJURY DICE', 'HEAVY', 'RISKY', 'TWO-HANDED'], description: '18", AUTOMATIC 3, +1 DICE, -1 INJURY DICE, HEAVY, RISKY, TWO-HANDED. Warbike Only.' },
  { id: 'zzap_gun', name: 'Zzap Gun', type: 'ranged', range: 36, cost: 15, limit: 2, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'HEAVY', 'DANGEROUS (NONLETHAL, STUN MARKERS)', 'STUN', 'TWO-HANDED'], description: '36", +1 INJURY DICE, HEAVY, DANGEROUS (NONLETHAL, STUN MARKERS), STUN, TWO-HANDED. LIMIT: 2. Mek or Big Mek Only.' },
  // Melee — Ork-specific
  ...
  { id: 'power_klaw', name: 'Power Klaw', type: 'melee', cost: 30, limit: 1, keywords: ['+1 INJURY DICE', 'CRITICAL', 'HEAVY', 'ARMOUR PIERCING 2', 'RISKY'], description: 'Melee, +1 INJURY DICE, CRITICAL, HEAVY, ARMOUR PIERCING 2, RISKY. LIMIT: 1.' },
  ...
  // Thrown
  { id: 'firey_stikkbombs', name: 'Firey Stikkbombs', type: 'ranged', range: 8, cost: 5, limit: 2, keywords: ['IGNORE ARMOUR on Critical Hit', 'ASSAULT', 'FIRE', 'FUMBLE (2-4)', 'IGNORE COVER', 'IGNORE LONG RANGE', 'RISKY', 'THROWN'], description: '8", IGNORE ARMOUR on Critical Hit, ASSAULT, FIRE, FUMBLE (2-4), IGNORE COVER, IGNORE LONG RANGE, RISKY, THROWN. LIMIT: 2.' },
  { id: 'krak_stikkbombs', name: 'Krak Stikkbombs', type: 'ranged', range: 8, cost: 7, limit: 2, keywords: ['ASSAULT', 'IGNORE COVER', 'IGNORE LONG RANGE', 'ARMOUR PIERCING 2', 'FUMBLE (2-4)', 'RISKY', 'THROWN'], description: '8", ASSAULT, IGNORE COVER, IGNORE LONG RANGE, ARMOUR PIERCING 2, FUMBLE (2-4), RISKY, THROWN. LIMIT: 2.' },
  { id: 'stikkbomb', name: 'Stikkbomb', type: 'ranged', range: 8, cost: 7, keywords: ['ASSAULT', 'BLAST 2"', 'FUMBLE (2-4)', 'IGNORE COVER', 'IGNORE LONG RANGE', 'RISKY', 'SHRAPNEL', 'THROWN'], description: '8", ASSAULT, BLAST 2", FUMBLE (2-4), IGNORE COVER, IGNORE LONG RANGE, RISKY, SHRAPNEL, THROWN.' },
  { id: 'throwing_knives_orks', name: 'Throwing Knives', type: 'ranged', range: 8, cost: 5, keywords: ['IGNORE LONG RANGE', 'ASSAULT', 'THROWN'], description: '8", IGNORE LONG RANGE, ASSAULT, THROWN. Kommando Only.' },
  // Campaign Shop Weapons
  { id: 'choppa_of_da_great_waaagh', name: "Choppa Of Da Great Waaagh!", type: 'melee', cost: 10, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['DEADLY', 'CRITICAL', 'HEAVY', 'TWO-HANDED'], description: "Melee, DEADLY, CRITICAL, HEAVY, TWO-HANDED. You can use your Waaagh! rule a second time during each battle. 10 Glory. LIMIT: 1. Warboss Only.", restrictedTo: ['LEADER'] },
  { id: 'da_dead_shiny_shoota', name: "Da Dead Shiny Shoota", type: 'ranged', range: 18, cost: 4, costCurrency: 'glory', limit: 1, keywords: ['AUTOMATIC 5', 'HEAVY', '-1 DICE'], description: '18", AUTOMATIC 5, HEAVY, -1 DICE. 4 Glory. LIMIT: 1. Elite Only.', restrictedTo: ['ELITE'] },
  { id: 'da_killa_klaw', name: "Da Killa Klaw", type: 'melee', cost: 5, costCurrency: 'glory', limit: 1, isMainHandOnly: true, keywords: ['+2 INJURY DICE', 'IGNORE ARMOUR', 'CRITICAL', 'HEAVY', 'RISKY', 'MAIN HAND ONLY'], description: "Melee, +2 INJURY DICE, IGNORE ARMOUR, CRITICAL, HEAVY, RISKY, MAIN HAND ONLY. 5 Glory. LIMIT: 1." },
  { id: 'da_souped_up_shokka', name: "Da Souped Up Shokka", type: 'ranged', range: 72, cost: 5, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+1 INJURY DICE', 'IGNORE COVER', 'IGNORE ARMOUR', 'STUN', 'HEAVY', 'TWO-HANDED', 'RISKY', 'DANGEROUS'], description: '72", +1 INJURY DICE, IGNORE COVER, IGNORE ARMOUR, STUN, HEAVY, TWO-HANDED, RISKY, DANGEROUS. 5 Glory. LIMIT: 1. Big Mek Only.' },
  { id: 'headwoppas_killchoppa', name: "Headwoppa's Killchoppa", type: 'melee', cost: 5, costCurrency: 'glory', limit: 1, handedness: 'two-handed', keywords: ['+2 INJURY DICE', 'VICIOUS 10', 'CRITICAL', 'HEAVY', 'TWO-HANDED'], description: "Melee, +2 INJURY DICE, VICIOUS 10, CRITICAL, HEAVY, TWO-HANDED. 5 Glory. LIMIT: 1." },
];
...
export const chaosDaemonsWeapons: Weapon[] = [
  // Blood Legion
  { id: 'scorched_skull_cannon', name: 'Scorched Skull Cannon', type: 'ranged', range: 24, cost: 15, limit: 2, handedness: 'two-handed', keywords: ['BLAST 2"', 'FIRE', 'RISKY', 'TWO-HANDED'], description: '24", BLAST 2", FIRE, RISKY, TWO-HANDED. LIMIT: 2. Blood Legion.' },
  ...
  { id: 'alluring_musk', name: 'Alluring Musk', type: 'ranged', range: 8, cost: 35, limit: 1, keywords: ['IGNORE COVER', 'IGNORE LONG RANGE', 'GAS', 'THROWN'], description: '8", IGNORE COVER, Long Range, GAS, THROWN. LIMIT: 1. Pulls target into melee. Enemies cannot Retreat from wielder. Legion of Excess.' },
  // Plague Legion
  { id: 'deaths_heads', name: "Death's Heads", type: 'ranged', range: 12, cost: 20, keywords: ['IGNORE ARMOUR', '-1 INJURY DICE', 'FUMBLE', 'INFECTION MARKERS', 'THROWN'], description: '12", IGNORE ARMOUR, -1 INJURY DICE, FUMBLE, INFECTION MARKERS, THROWN. Plague Legion.' },
  { id: 'rancid_vomit', name: 'Rancid Vomit', type: 'ranged', range: 6, cost: 12, keywords: ['ASSAULT', 'BLAST 2"', 'FUMBLE', 'GAS', 'THROWN'], description: '6", ASSAULT, BLAST 2", FUMBLE, GAS, THROWN. Plague Legion.' },
  ...
  { id: 'ritual_dagger', name: 'Ritual Dagger', type: 'melee', cost: 23, limit: 1, keywords: ['+2 INJURY MODIFIER', 'CRITICAL', 'RISKY'], description: '+2 INJURY MODIFIER, CRITICAL, RISKY. LIMIT: 1. Elite Only. Scintillating Legion.' },
...
export const adeptusAstartesVariantWeapons: Weapon[] = [
  ...
  },
  {
    ...
    costCurrency: 'glory' as const,
    limit: 1,
    keywords: ['ASSAULT', '+1 DICE'],
    description: '12", ASSAULT, +1 DICE. Takes no hands; can be used in addition to any other weapon when taking the Shoot Action. LIMIT: 1. Mounted on Astartes Bike Only. White Scars Only. (AA Campaign Shop)',
  },
  {
...
export const factionSpecificWeaponIds = new Set<string>([
  ...
  'throwing_power_knives_al', 'blasting_charge_al', 'melta_bombs_al',
  ...
  // ── Campaign Shop weapons missing from initial set population ──────────────
  ...
  'soulshard_grenades_drukhari', 'animus_vitae_drukhari', 'djin_blade_drukhari',
  'parasite_kiss_drukhari', 'tormentrix_drukhari', 'triptych_whip_drukhari',
  // Aeldari Campaign Shop
  'avenging_blade_aeldari', 'exile_glaive_aeldari', 'firesabre_aeldari', 'shard_of_anaris_aeldari',
  ...
  // Orks Campaign Shop
  'choppa_of_da_great_waaagh', 'da_dead_shiny_shoota', 'da_killa_klaw', 'da_souped_up_shokka', 'headwoppas_killchoppa',
...
// ============================================================================
// GENESTEALER CULTS FACTION WEAPONS
// ============================================================================
export const genestealerCultsWeapons: Weapon[] = [
  // Campaign Shop Weapons
  { id: 'dagger_of_swift_sacrifice_gsc', name: 'Dagger of Swift Sacrifice', type: 'melee', cost: 2, costCurrency: 'glory', limit: 1, keywords: ['+2 INJURY MODIFIER'], description: 'Melee, +2 INJURY MODIFIER. 2 Glory. LIMIT: 1. Primus Only.', restrictedTo: ['ELITE'] },
  { id: 'gift_from_beyond_gsc', name: 'Gift From Beyond', type: 'ranged', range: 48, cost: 4, costCurrency: 'glory', limit: 1, keywords: ['+1 DICE', '+1 INJURY DICE', 'CRITICAL', 'RISKY'], description: '48", +1 DICE, +1 INJURY DICE, CRITICAL, RISKY, Scope Capable. Enemy models cannot change the target of this attack. 4 Glory. LIMIT: 1.' },
  { id: 'oppressors_bane_gsc', name: "Oppressor's Bane", type: 'ranged', range: 15, cost: 2, costCurrency: 'glory', limit: 1, keywords: ['+1 INJURY DICE vs CROSSFIRE', 'ASSAULT', 'PISTOL'], description: '15", +1 INJURY DICE against a target with a Crossfire token, ASSAULT, PISTOL, Scope Capable. 2 Glory. LIMIT: 1. Brood Brothers Only.' },
];
...
export const allWeapons: Weapon[] = [
  ...
  // Genestealer Cults faction weapons (campaign shop)
  ...genestealerCultsWeapons,
