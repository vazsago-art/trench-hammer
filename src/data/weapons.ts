...
export const sharedHeavyRangedWeapons: Weapon[] = [
  ...
  },
  {
    ...
    description: '36" +1 INJURY DICE, HEAVY, TWO-HANDED.'
  },
  {
    id: 'mining_laser',
    name: 'Mining Laser',
  ...
  },
  {
    ...
    cost: 40,
    handedness: 'two-handed',
    keywords: ['+1 DICE', '+1 INJURY DICE', 'HEAVY', 'TWO-HANDED'],
    description: '36" +1 DICE, +1 INJURY DICE, HEAVY, TWO-HANDED.'
  },
  {
    id: 'harpoon_launcher',
...
export const sharedSpecialMeleeWeapons: Weapon[] = [
  ...
  },
  {
    ...
    cost: 15,
    handedness: 'two-handed',
    keywords: ['BLOCK', 'CRITICAL', 'RISKY', 'SHRAPNEL', 'TWO-HANDED'],
    description: 'Melee, BLOCK, CRITICAL, RISKY, SHRAPNEL, TWO-HANDED. Has Shield Combo.'
  },
  {
    id: 'force_rod',
    name: 'Force Rod',
  ...
  },
  {
    ...
    type: 'melee',
    cost: 12,
    keywords: ['ARMOUR PIERCING 1', 'STUN'],
    description: 'Melee, ARMOUR PIERCING 1, STUN.'
  },
  {
    id: 'plasma_blade',
    name: 'Plasma Blade',
...
export const sharedHeavyMeleeWeapons: Weapon[] = [
  {
    ...
    type: 'melee',
    cost: 35,
    keywords: ['+1 INJURY DICE', 'CRITICAL', 'HEAVY', 'ARMOUR PIERCING 1', 'RISKY', 'SHRAPNEL'],
    description: 'Melee, +1 INJURY DICE, CRITICAL, HEAVY, ARMOUR PIERCING 1, RISKY, SHRAPNEL.'
  },
  {
    id: 'eviscerator',
    name: 'Eviscerator',
  ...
  },
  {
    ...
    type: 'melee',
    cost: 30,
    keywords: ['+1 INJURY MODIFIER', 'HEAVY', 'ARMOUR PIERCING 2'],
    description: 'Melee, +1 INJURY MODIFIER, HEAVY, ARMOUR PIERCING 2.'
  },
  {
...
export const necronsRangedWeapons: Weapon[] = [
  ...
  },
  {
    ...
    cost: 15,
    handedness: 'two-handed',
    keywords: ['ASSAULT', 'CRITICAL', 'STUN', 'HEAVY', 'TWO-HANDED'],
    description: '24" ASSAULT, CRITICAL, STUN, HEAVY, TWO-HANDED.',
  },
  // Necron Pistols
  {
  ...
  // Necron Heavy Ranged
  {
    ...
    description: '36" ARMOUR PIERCING 2, CRITICAL, HEAVY, TWO-HANDED.',
  },
  {
    id: 'heat_ray_nec',
    name: 'Heat Ray',
    ...
    description: '12" FLAMETHROWER, FIRE, HEAVY, TWO-HANDED. Can target up to 3 different enemies.',
  },
  {
  ...
  },
  {
    ...
    description: '24" BLAST 3", HEAVY, STUN, TWO-HANDED.',
  },
  {
  ...
  },
  {
    ...
    cost: 20,
    handedness: 'two-handed',
    keywords: ['+1 DICE', 'ASSAULT', 'CRITICAL', 'STUN', 'HEAVY', 'TWO-HANDED'],
    description: '24" +1 DICE, ASSAULT, CRITICAL, STUN, HEAVY, TWO-HANDED. Tomb Blade Only.',
  },
...
export const adeptusMiniStorumWeapons: Weapon[] = [
  ...
  },
  {
    ...
    limit: 1,
    handedness: 'two-handed',
    keywords: ['TWO-HANDED', 'HELD', 'CRITICAL', 'RISKY', 'SHRAPNEL'],
    description: 'TWO-HANDED, HELD. Chain Blade: Melee, CRITICAL, RISKY, SHRAPNEL, CUMBERSOME. Torch: 8" FLAMETHROWER, IGNORE ARMOUR, FIRE. LIMIT: 1.',
  },
];
...
export const officioAssassinorumWeapons: Weapon[] = [
  ...
  },
  {
    ...
    type: 'ranged',
    cost: 7,
    keywords: ['IGNORE ARMOUR', '+1 INJURY DICE vs DAEMON/PSYKER', 'BLAST 2"', 'IGNORE COVER', 'IGNORE LONG RANGE', 'PSYCHIC', 'ASSAULT', 'STUN', 'THROWN'],
    description: '8", IGNORE ARMOUR, +1 INJURY DICE vs DAEMON/PSYKER, BLAST 2", IGNORE COVER, IGNORE LONG RANGE, PSYCHIC, ASSAULT, STUN, THROWN. (Culexus Only)',
  },
];
...
export const adeptusMechanicusWeapons: Weapon[] = [
  ...
  },
  {
    ...
    description: '8", FLAMETHROWER, IGNORE ARMOUR, -1 INJURY DICE, GAS, TWO-HANDED. Serberys Only. (Skitarii Hunter Cohort Only)'
  },
  {
